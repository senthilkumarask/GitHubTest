...
public class TestCreateHSWRegistryClient extends BaseTestCase {
	...
	public TestCreateHSWRegistryClient(String name) {
		super(name);
	}

	/**
	 * Test case to create house warming type registry
	 * @throws IOException 
	 * @throws JSONException 
	 */
	public void testCreateHSWReg() throws IOException, JSONException {
	 ...
	 * @throws JSONException 
	 */
	public void testCreateHSWRegError() throws IOException, JSONException {
		String exception = null;
		String username = (String) getObject("username");
		String password = (String) getObject("password");
		String httpMethod = (String) getObject("httpmethod");
