 ...
 *
 */
public class TestUpdateCreditCard extends BaseTestCase  {

	public TestUpdateCreditCard(String name) {
		super(name);
	...
	/**
	 * Test for Update Credit Card success scenario
	 */
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public void testUpdateCreditCard() throws RestClientException, JSONException, IOException{
		...
		try {
            ...
            params.put("atg-rest-return-form-handler-properties", "true");
             ...
             params.put("atg-rest-return-form-handler-properties", "true");
			 pd = mSession.createHttpRequest("http://" + getHost() +":" + getPort()+(String) getObject("updateCreditCardRequest"), params,"POST");
		...
		/**
		 * Test for Update Credit Card error scenario
		 */		
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public void testUpdateCreditCardError() throws RestClientException, JSONException, IOException{
		mSession = getNewHttpSession();
		mSession.setUseHttpsForLogin(false);
		mSession.setUseInternalProfileForLogin(false);
		RestResult pd =  null;
