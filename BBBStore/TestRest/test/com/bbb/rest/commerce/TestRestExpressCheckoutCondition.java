...
public class TestRestExpressCheckoutCondition extends BaseTestCase {
	RestSession mSession;
	HashMap params = null;

	public TestRestExpressCheckoutCondition(String name) {
		super(name);
	}
	...
	public void testGetExpressCheckoutCondition() throws RestClientException, JSONException, IOException{
		...
		try {
			...
			pd1 = mSession.createHttpRequest(
					"http://"
							...
							+ ":"
							+ getPort()
							+ (String) getObject("getExpressCheckoutConditionRequest"), params,"POST");
