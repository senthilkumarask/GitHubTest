					...
					<div title="${chatAvailable}">
						<dsp:form id="frmLiveChat" method="post" action="${chatURL}">
                            ...
                            <div class="marTop_20 buttonpane clearfix">
                                <div class="ui-dialog-buttonset">
                                    <div class="button button_active">
                                        <input type="submit" value="CHAT NOW" name="chatNow" id="chatNow" onclick="javascript:omnitureExternalLinks('rightnow: chat button')" role="button" aria-label="Chat now with a representative"/>
                                    </div>
                                    <a href="#" title="cancle link" role="link" class="buttonTextLink close-any-dialog"><bbbl:label key="lbl_payament_button_cancel" language="${pageContext.request.locale.language}" /></a>
                                </div>
                            </div>
						</dsp:form>
					</div>
