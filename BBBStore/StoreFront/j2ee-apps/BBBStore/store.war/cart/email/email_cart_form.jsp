...
<dsp:importbean bean="/com/bbb/commerce/cart/EmailCartFormHandler"/>	
	    ...
	    <!--<dsp:setvalue bean="EmailCartFormHandler.successURL"  value="/store/cart/email/response_email_cart_json.jsp"/>
	    <dsp:setvalue bean="EmailCartFormHandler.errorURL" value="/store/cart/email/response_email_cart_json.jsp"/>-->
