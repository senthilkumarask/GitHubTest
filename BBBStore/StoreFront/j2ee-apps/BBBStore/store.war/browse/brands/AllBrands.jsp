		...
		<dsp:getvalueof id="currentSiteId" bean="/atg/multisite/Site.id" /> 
			 <dsp:droplet name="/atg/dynamo/droplet/Cache">
		        ...
		        <dsp:oparam name="output">
					<div id="content" class="category container_12 clearfix" role="main">
						<div class="grid_12">
							<h1><bbbl:label key="lbl_brandslisting_brandsheading" language="${pageContext.request.locale.language}" /></h1>
