...
<input type="hidden" class="isInStock" value="${inStock}"/>
									<ul class="prodInfo">
										<li class="prodName marBottom_10">
											<span class="fl productName" itemprop="name"><dsp:valueof param="element.name" valueishtml="true"/></span>
										</li>
								...
								<c:if test="${(null eq emailStockAlertsEnabled) || (emailStockAlertsEnabled==true)}">
									<div class="priceQuantityNotAvailable <c:if test="${inStock==true}">hidden</c:if> fl width_12">
									      <div class="message fr">
									             ...
									             <a class="info fl marLeft_10 lnkNotifyOOS" href="#"><bbbl:label key='lbl_pdp_product_notify_item_available' language="${pageContext.request.locale.language}" /> &raquo;</a>
									      </div>
									</div>
								</c:if>
							...
							<div class="fr prodInfoContainer grid_10 noMar">
								<div class="prodReviewContainer grid_4 fl noMar">
										<ul class="prodInfo">
