...
<div>
	<ul class="overview">
		...
		<li>
			<a href="${contextPath}/account/order_summary.jsp" ${currentPage eq currentPageLabel ?' class="active"':' class="recognizedUser"'}>${currentPageLabel}</a>
		</li>
		...
		<li>
		  	<a href="${contextPath}/account/address_book.jsp" ${currentPage eq currentPageLabel ?' class="active"':' class="recognizedUser"'}>${currentPageLabel}</a>
		</li>
		...
		<li>
		    <a href="${contextPath}/account/view_credit_card.jsp" ${currentPage eq currentPageLabel ?' class="active"':' class="recognizedUser"'}>${currentPageLabel}</a>
		</li>
		...
		<li>
			<a href="${contextPath}/giftregistry/my_registries.jsp" ${currentPage eq currentPageLabel ?' class="active"':' class="recognizedUser"'}>${currentPageLabel}</a>
		</li>
		...
		<c:set var="currentPageLabel">
	   	...
	   	<li>
			<a href="${contextPath}/account/personalinfo.jsp" ${currentPage eq currentPageLabel ?' class="active"':' class="recognizedUser"'}>${currentPageLabel}</a>
		</li>
		...
		<c:if test= "${HarteHanksOn}">
			...
			<li>
				<a href="${contextPath}/account/preferences.jsp" ${currentPage eq currentPageLabel ?' class="active"':' class="recognizedUser"'}>${currentPageLabel}</a>
			</li>
		</c:if>
