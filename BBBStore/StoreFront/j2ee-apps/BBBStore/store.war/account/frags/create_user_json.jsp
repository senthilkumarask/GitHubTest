<dsp:page>
	...
	<dsp:getvalueof var="writeReviewSuccessURL" bean="ProfileFormHandler.writeReviewSuccessURL"/>
	<dsp:getvalueof var="uemail" bean="SessionBean.userEmailId"/>
	<dsp:droplet name="IsEmpty">
		...
		<dsp:oparam name="true">
			<dsp:droplet name="IsEmpty">
				...
				<dsp:oparam name="true">
					<dsp:getvalueof id="email" value="${uemail}" scope="session"/>
					<json:object>
						...
						<json:property name="writeReviewSuccessURL">${writeReviewSuccessURL}</json:property>
