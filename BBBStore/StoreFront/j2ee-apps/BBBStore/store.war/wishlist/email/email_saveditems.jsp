...
<c:set var="submit" scope="page">
	...
	<div id="cartEmailContent">		
		<p>${intro}</p>
	    <dsp:form id="emailCart" action="email/response_email_saveditems_json.jsp" method="post">
	       
			<div class="input clearfix">
				<div class="label">
					<%-- <label for="email">${email}</label> --%>
					<label id="lblemail" for="email">Email Saved Items</label>
				</div>
				<div class="text">
					<div class="width_3 alpha">
						...
						<%-- <dsp:input type="hidden" bean="EmailSavedItemsFormHandler.emailType" name="message" value="EmailSavedItems" /> --%>
					</div>
				</div>			
			</div>
			<div class="input clearfix">
				...
				<div class="text">
					<div class="width_3 alpha">
						<dsp:input type="text" bean="EmailSavedItemsFormHandler.senderEmail" name="yourEmail" value="" iclass="required">
						<dsp:tagAttribute name="aria-required" value="true"/>
