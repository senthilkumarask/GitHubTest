			...
			<dsp:droplet name="/atg/dynamo/droplet/ForEach">
					<dsp:param name="array" param="stateItem"/>
						...
						<dsp:getvalueof var="countAttribute" param="count" />
								...
								<li class="map"><a target="_blank" href='<dsp:valueof param="element.bridalShowViewDirection"/>${address}'><bbbl:label key="lbl_bridalshow_view_directions" language="${pageContext.request.locale.language}" /></a></li>
							</ul>
						</li>
