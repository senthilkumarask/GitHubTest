...
<bbb:pageContainer>
	...
	<jsp:attribute name="pageWrapper">bridalBook flashBookPage</jsp:attribute>
<jsp:body>
		<jsp:useBean id="placeHolderMap" class="java.util.HashMap" scope="request"/>
	 	<c:set target="${placeHolderMap}" property="pageName" value="Bridal Book"/>
        <div id="content" class="container_12 clearfix noPad" role="main">
			<div class="grid_12 clearfix">
				<h1><bbbl:label key="lbl_bridalbook_howbook_page_title" language="${pageContext.request.locale.language}" /></h1>
			</div>
            <div class="clear"></div>
          ...
          if(typeof s !=='undefined') {
			s.channel = 'Registry';
			s.pageName='Bridal Book - Look Inside';// pagename
