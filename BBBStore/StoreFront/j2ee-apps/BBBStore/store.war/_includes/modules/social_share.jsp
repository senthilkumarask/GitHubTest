    ...
    <div class="spacer" data-socialshare-ui-role="dialogContent">
        <div class="ui-dialog titleWrapper" data-socialshare-ui-role="headingWrapper">
            <div class="ui-dialog-titlebar noMar noPad">
                ...
                <a href="#close" data-socialshare-role="button" data-socialshare-action="closeDialog" class="btnCloseWin ui-dialog-titlebar-close posRight posTop" title="Close"><span class="ui-icon ui-icon-closethick"><bbbl:label key="lbl_js_close_button" language="${pageContext.request.locale.language}" /></span></a>
            </div>
        </div>
        <div class="clear"></div>
            ...
            <div class="carousel clearfix"> 
                <div class="carouselBody width_2 fl clearfix noMar"> 
                    ...
                    <div class="carouselArrows width_2 fl clearfix noMar" data-socialshare-ui-role="imageCarouselArrows"> 
                        <a class="carouselScrollPrevious noMar fl" title="Previous" href="#"><bbbl:label key="lbl_multi_gift_previous" language="${pageContext.request.locale.language}" /></a>
                        <span class="fl arrowLabel"><bbbl:label key="lbl_change_item" language="${pageContext.request.locale.language}" /></span>
                        <a class="carouselScrollNext noMar fl" title="Next" href="#"><bbbl:label key="lbl_multi_gift_next" language="${pageContext.request.locale.language}" /></a>
                        <div class="clear"></div>
                    </div>
                    <div class="clear"></div>
                </div>
            ...
            <div id="twitterShare" data-socialshare-role="dialog" data-socialshare-network="twitter" class="width_5 clearfix hidden sharingOption">
                <form class="clearfix" name="frmSocialShare" action="#socialShare">
                    ...
                    <div class="cb buttonset clearfix">
                        ...
                        <a href="#socialShareDialog" class="buttonTextLink btnCancelShare" data-socialshare-role="button" data-socialshare-action="closeDialog"><bbbl:label key="lbl_profile_Cancel" language="${pageContext.request.locale.language}" /></a>
                        <div class="clear"></div>
                    </div>
                    <p class="shareMessage"><bbbl:label key="lbl_product_link_in_tweet" language="${pageContext.request.locale.language}" />, <bbbl:label key="lbl_charac_count_accounted" language="${pageContext.request.locale.language}" /></p>
                </form>
            </div>
