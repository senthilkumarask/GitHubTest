...
<div class="pagination">	
	<form id="frmPagination" method="post" action="#">
		...
		<legend class="offScreen"><bbbl:label key="lbl_search_tab_text_guides" language="${pageContext.request.locale.language}" /></legend>
				...
				<ul class="pagLevel1UL">
					...
					<li class="listSort">
						...
						<select	class="sortOptions dynFormSubmit" data-submit-param-length="1" data-submit-param1-name="origSearchTerm" data-submit-param1-value="${origSearchTerm}"
							id="pagSortOptTop" name="pagSortOpt" aria-required="false" aria-live="assertive" aria-labelledby="pagSortOptTop">
				...
				<%-- START : R2.2 Story - 116-D1 & D2 --%>
					...
					<ul class="pagLevel1UL">
						...
						<label  class="txtOffScreen" for="pagFilterOpt"><bbbl:label key="lbl_guide_perpage" language="${pageContext.request.locale.language}" /></label>
							...
							<select	class="dynFormSubmit" data-submit-param-length="1" data-submit-param1-name="origSearchTerm" data-submit-param1-value="${origSearchTerm}" id="pagFilterOptUp" name="pagFilterOpt" aria-required="false" aria-live="assertive" aria-labelledby="pagFilterOptUp">
								...
								<c:choose>
									<c:when test="${currentPage eq 1 || currentPage eq 2 }">
										<c:if test="${currentPage eq 1}">
											<li class="active"><a class="dynFormSubmit" data-submit-param-length="1" data-submit-param1-name="origSearchTerm" data-submit-param1-value="${origSearchTerm}" title="1" href="${url}${filterAppliedWithPrefix}/${seoPageNoFirstPage}?${firstPageURL}${searchQueryParams}${vendorParam}">${currentPage}</a></li>
										</c:if>
