...
<c:choose>
     <c:when test="${regType eq 'COL' }">
      <div id="cmsCarousel" class="grid_12">
						...
						<div class="carousel">
							...
							<div class="carouselPages">
								...
								<div class="carouselArrow carouselArrowNext">
									<a class="carouselScrollNext" title="Next" href="#"><bbbl:label key="lbl_spc_shipping_button_next" language="${pageContext.request.locale.language}" /></a>
								</div>
							</div>
						</div>
					</div>
