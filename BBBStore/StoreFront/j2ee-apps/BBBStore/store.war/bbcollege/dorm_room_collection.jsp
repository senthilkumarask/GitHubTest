											...
											<div class="pushDown">
												<ul class="prodInfo">
													...
													<c:otherwise>
														...
														<li class="prodReview writeReview"><a href="${finalUrl}?writeReview=true" title="${writeReviewLink}" role="link" aria-label="${writeReviewLink} ${lblAboutThe} ${productName}"><bbbl:label key='lbl_grid_write_review_link' language="${pageContext.request.locale.language}" /></a></li>
													</c:otherwise>
													</c:choose>
													</c:if>
												</ul>
