							 ...
							 <table border="0" cellpadding="0" cellspacing="0" width="100%" align="left" style="width: 280px; margin-bottom:10px;">
								<tbody>
									<dsp:droplet name="/atg/dynamo/droplet/ForEach">
										...
										<dsp:oparam name="output">
										<tr>
											<td valign="top"><bbbl:label key="lbl_spc_preview_giftcard" language="<c:out param='${language}'/>"/></td>
											<td valign="top" align="right">
												<dsp:getvalueof id="cardNumber" param="giftcard.cardNumber"/>
												<bbbl:label key="lbl_spc_preview_giftcardMask" language="<c:out param='${language}'/>"/> ${fn:substring(cardNumber,fn:length(cardNumber)-4,fn:length(cardNumber))}
											</td>
										</tr>
										<tr>
											<td valign="top"><bbbl:label key="lbl_spc_preview_giftcardamount" language="<c:out param='${language}'/>"/></td>
											<td valign="top" align="right">
