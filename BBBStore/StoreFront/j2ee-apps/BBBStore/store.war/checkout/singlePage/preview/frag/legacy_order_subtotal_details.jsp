                    	  ...
                    	  <dsp:getvalueof var="totalAmount" param="orderHeaderInfo.totalAmt"/>
							...
							<c:choose>
								<c:when test="${totalShippingAmount gt 0.0}">
									<dt><span class="bold"><bbbl:label key="lbl_spc_cartdetail_estimatedshipping" language="<c:out param='${language}'/>"/>:</span> <a href="${contextPath}/static/shippingexclusionsinclusions" class="popup"><bbbl:label key="lbl_spc_exclusion_inclusion_details" language="<c:out param='${language}'/>"/></a></dt> 
