<dsp:page>
	<dsp:include page="/checkout/singlePage/preview/frag/display_address.jsp" flush="true">
	...
	<dsp:include page="/checkout/singlePage/preview/frag/shipping_method.jsp" flush="true">
		<dsp:param name="shippingGroup" param="shippingGroup"  />
		<dsp:param name="orderDate" param="orderDate"/>
		<dsp:param name="isPackAndHoldFlag" param="isPackAndHoldFlag"/>
	</dsp:include>
</dsp:page>