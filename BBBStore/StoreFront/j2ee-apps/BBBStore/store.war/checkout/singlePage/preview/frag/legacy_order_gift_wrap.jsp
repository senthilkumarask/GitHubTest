<dsp:page>
	...
	<div class="grid_3 omega">
		<p><strong><bbbl:label key="lbl_spc_preview_giftoptions" language="<c:out param='${language}'/>"/></strong></p>
		<div class="clearfix marTop_5">
			<p class="fl"><bbbl:label key="lbl_spc_preview_giftpackage" language="<c:out param='${language}'/>"/></p>
			<p class="fr">
				<c:choose>
		...
		<p class="marTop_5"><bbbl:label key="lbl_spc_preview_message" language="<c:out param='${language}'/>"/></p>
