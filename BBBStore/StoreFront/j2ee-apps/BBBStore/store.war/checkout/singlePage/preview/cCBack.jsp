...
<dsp:page>
    ...
    <c:choose>
        <c:when test="${token eq 'cCFrame'}">
            ...
            <dsp:getvalueof var="TermUrl" value="${pageContext.request.scheme}://${pageContext.request.serverName}/store/checkout/singlePage/preview/cCResponse.jsp" scope="request" />
