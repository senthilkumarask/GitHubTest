...
<div id="editAddressDialog" title="Billing Address" style="display:none;">
    <dsp:droplet name="/atg/dynamo/droplet/Switch">
        <dsp:param name="value" bean="BBBSPBillingAddressFormHandler.formError"/>
        <dsp:oparam name="false">
            <dsp:setvalue bean="BBBSPBillingAddressFormHandler.orderAddress" beanvalue="/atg/commerce/ShoppingCart.current.billingAddress"/>
        </dsp:oparam>
    </dsp:droplet>
    ...
    <%-- <form class="form" id="editAddressDialogForm" action="index.jsp" method="post"> --%>
        <div class="container_6 clearfix">
            <p class="ccNameNumber hidden marTop_10 marBottom_10"><bbbl:label key="lbl_spc_billing_address_edit_for" language="<c:out param='${language}'/>"/> <span class="ccInfo"></span></p>
            <div class="grid_3 noMar">
                <dsp:input type="hidden" name="checkoutEmail" id="checkoutEmail"
                    bean="BBBSPBillingAddressFormHandler.billingAddress.email" beanvalue="ShoppingCart.current.billingAddress.email"/>
                ...
                <dsp:input type="hidden" id="checkoutPhone"
                    bean="BBBSPBillingAddressFormHandler.billingAddress.mobileNumber" value="${mobileNumber}" />
                 <div class="inputField clearfix">
                    <label id="lbltxtAddressBookEditFirstName" for="txtAddressBookEditFirstName"><bbbl:label key="lbl_spc_shipping_new_first_name" language="<c:out param='${language}'/>"/> <span class="required">*</span></label>
                    <dsp:input type="text" name="txtAddressBookAddFirstNameName" id="txtAddressBookEditFirstName"
								bean="BBBSPBillingAddressFormHandler.billingAddress.firstName" >
               ...
               <div class="inputField clearfix">
                    <label id="lbltxtAddressBookEditLastName" for="txtAddressBookEditLastName"><bbbl:label key="lbl_spc_shipping_new_last_name" language="<c:out param='${language}'/>"/> <span class="required">*</span></label>
               ...
               <div class="inputField clearfix">
                    <label id="lbltxtAddressBookEditCompany" for="txtAddressBookEditCompany"><bbbl:label key="lbl_spc_shipping_new_company" language="<c:out param='${language}'/>"/></label>
                        ...
                        <c:when test="${internationalCCFlag}">
                            <div class="checkboxItem clearfix input marTop_10 noBorder saveToAccountWrapper hidden">
                                <div class="checkbox fl noMarRight">
                                    <dsp:input type="checkbox" name="saveToAccount" bean="BBBSPBillingAddressFormHandler.saveToAccount" disabled="true" id="saveToAccountEDITADDR" value="TRUE" >
                                        <dsp:tagAttribute name="aria-checked" value="true"/>
                                    </dsp:input>
                                </div>
                                <div class="label">
                                    <label for="saveToAccountEDITADDR"><bbbl:label key="lbl_spc_shipping_new_save_account" language="${pageContext.request.locale.language}" /></label>
                                </div>
                            </div>
                        </c:when>
                        <c:otherwise>
                            <div class="checkboxItem clearfix input marTop_10 noBorder saveToAccountWrapper">
                                <div class="checkbox fl noMarRight">
                                    <dsp:input type="checkbox" name="saveToAccount" bean="BBBSPBillingAddressFormHandler.saveToAccount" id="saveToAccountEDITADDR" value="TRUE" >
                                        <dsp:tagAttribute name="aria-checked" value="true"/>
                                    </dsp:input>
                                </div>
                                <div class="label">
					...
					<div class="select">
						<dsp:droplet name="BBBCountriesDroplet">
							<dsp:oparam name="output">
								<dsp:getvalueof var="currentCountryName" bean="BBBSPBillingAddressFormHandler.billingAddress.country"/>
									<c:choose>
										<c:when test="${empty preFillValues || preFillValues}">
											<dsp:select name="countryName" id="countryName"  bean="BBBSPBillingAddressFormHandler.billingAddress.country" iclass="uniform">
			                                    <dsp:tagAttribute name="aria-required" value="true"/>
										...
										<c:otherwise>
											<dsp:select name="countryName" id="countryName"  bean="BBBSPBillingAddressFormHandler.billingAddress.country" nodefault="true" iclass="uniform">
			                                    <dsp:tagAttribute name="aria-required" value="true"/>
			                                    <dsp:tagAttribute name="aria-labelledby" value="lblcountryName errorcountryName"/>
												<option value=""><bbbl:label key="lbl_intl_shipping_modal_select_country" language="${pageContext.request.locale.language}" /></option>
												<dsp:droplet name="ForEach">
...
<%-- 		R2.1.1 International Credit Card ends --%>
                <div class="inputField clearfix">
                   <label id="lbltxtAddressBookEditAddress1" for="txtAddressBookEditAddress1"><bbbl:label key="lbl_spc_shipping_address1" language="<c:out param='${language}'/>"/> <span class="required">*</span></label>
                ...
                <div class="inputField clearfix">
                    <label id="lbltxtAddressBookEditAddress2" for="txtAddressBookEditAddress2"><bbbl:label key="lbl_spc_shipping_address2" language="<c:out param='${language}'/>"/></label>
                    ...
                    <dsp:input type="text"  name="txtAddressBookEditAddress2Name" id="txtAddressBookEditAddress2"
									bean="BBBSPBillingAddressFormHandler.billingAddress.address2" >
                        <dsp:tagAttribute name="aria-required" value="false"/>
                ...
                <div class="inputField clearfix">
                    <label id="lbltxtAddressBookEditCity" for="txtAddressBookEditCity"><bbbl:label key="lbl_spc_shipping_new_city" language="<c:out param='${language}'/>"/> <span class="required">*</span></label>
                 ...
                 <div class="inputField clearfix stateSelectWrapper">
                    <label for="selAddressBookEditState" id="stateLbl"><span class="stateLabelText"><bbbl:label key="lbl_spc_shipping_new_state" language="<c:out param='${language}'/>"/></span> <span class="required">*</span></label>
                    ...
                    <dsp:param name="NoShowUSTerr" value="noShowOnBilling" />
							<dsp:oparam name="output">
									...
									<c:choose>
										<c:when test="${empty preFillValues || preFillValues}">
											<dsp:select name="selAddressBookEditStateName" id="selAddressBookEditState"
												bean="BBBSPBillingAddressFormHandler.billingAddress.state" iclass="uniform">
                                                <dsp:tagAttribute name="aria-required" value="true"/>
								...
								<label for="selAddressBookEditState" class="offScreen"><bbbl:label key="lbl_spc_shipping_new_state" language="<c:out param='${language}'/>"/> <span class="required">*</span></label>
							</dsp:oparam>
						</dsp:droplet>
                </div>
                <%-- INPUT SELECT --%>
                <div class="inputField stateTextWrapper hidden">
                    ...
                    <div class="text">
                        <div>
	                        ...
	                        <dsp:input type="hidden" value="" id="stateTextInt" bean="BBBSPBillingAddressFormHandler.billingAddress.state" />
                        </div>
                    </div>
                </div>
                ...
                <%-- END INPUT SELECT --%>
				<div class="inputField clearfix">
					<label for="txtAddressBookEditZip" id="lblZipCode"><span class="zipCodeLabelText"><bbbl:label key="lbl_spc_shipping_new_zip" language="<c:out param='${language}'/>"/></span> <span class="required">*</span></label> 
                    <c:choose>
                    ...
                    <dsp:input type="hidden" id="zipAll" value="" bean="BBBSPBillingAddressFormHandler.billingAddress.postalCode" ></dsp:input> 	
				</div>
				
            </div>
        </div>
        
        <dsp:input type="hidden" bean="BBBSPBillingAddressFormHandler.userSelectedOption" value="EDIT"/>
        <!--<dsp:input type="hidden" bean="BBBSPBillingAddressFormHandler.successURL" value="/store/checkout/payment/billing_payment.jsp"/>
        <dsp:input type="hidden" bean="BBBSPBillingAddressFormHandler.errorURL" value="/store/checkout/payment/billing_payment.jsp"/>
        <dsp:input type="hidden" bean="BBBSPBillingAddressFormHandler.systemErrorURL" value="/store/checkout/payment/billing_payment.jsp"/>-->
        <%-- USED TO HANDLE RESPONSE --%>
        <dsp:input type="hidden" bean="BBBSPBillingAddressFormHandler.fromAjaxSubmission" value="true"/>
        
        <div class="marTop_20 buttonpane clearfix">
            <div class="ui-dialog-buttonset">
                <div class="button button_active">
                    <c:set var="lbl_button_save" scope="page">
                        <bbbl:label key="lbl_spc_payament_button_save"
...
<div id="updateAddressWarningDialog" title="Update Address" style="display:none;">
    <bbbl:label key="lbl_spc_billingaddresschange_note1" language="${pageContext.request.locale.language}" />
</div>
<div id="removeAddressWarningDialog" title="Remove Address" style="display:none;">
    <bbbl:label key="lbl_spc_billingaddresschange_note2" language="${pageContext.request.locale.language}" />
</div>
</dsp:page>
