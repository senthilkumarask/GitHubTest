    ...
    <div id="payWithGiftCardContainer" class="checkboxItem input clearfix payWithGiftCard noPad">
        <c:choose>
            <c:when test="${orderType eq 'BOPUS_ONLY'}">
                <h3 class="sectionHeading noBorder"><bbbl:label key="lbl_spc_gc_label2" language="<c:out param='${language}'/>"/></h3>
                <p class="noMar"><bbbl:label key="lbl_spc_gc_label1" language="<c:out param='${language}'/>"/></p>
            </c:when>
            <c:when test="${orderType ne 'BOPUS_ONLY'}">
                ...
                <%--
                        ...
                        <div class="label marBottom_10">
                            <label id="lblpayWith" for="payWith" class="payWithGirftCardLabel"><bbbl:label key="lbl_spc_gc_label2" language="<c:out param='${language}'/>"/></label>
                        </div>
                        <div class="clear"></div>
                    </dsp:oparam>
                    <dsp:oparam name="true">
                ...
                <%-- NOTE: if there is a gift card applied then giftcard section should be visible --%>
                <c:set var="hideGiftCards" value="" />
                <dsp:droplet name="Switch">
                    <dsp:param name="value" value="${isOrderAmtCoveredVar}"/>
                    <dsp:oparam name="false">
                        <dsp:droplet name="Switch">
                            ...
                            <dsp:oparam name="true">
                             ...
                             <dsp:oparam name="false">
                                <c:set var="hideGiftCards" value="hidden" />
                             </dsp:oparam>
                        </dsp:droplet>                        
                    </dsp:oparam>
                    <dsp:oparam name="true">
                ...
                <dsp:droplet name="BBBPaymentGroupDroplet">
                    ...
                    <dsp:oparam name="output">
                        ...
                        <div id="payWithGiftCard" class="subForm clearfix ${hideGiftCards}"> 
                            <div class="grid_6 alpha suffix_3 omega">
                                <dl class="payWithCard clearfix marBottom_10">
                                    <dt class="grid_3 alpha"><bbbl:label key="lbl_spc_gc_amtDue" language="<c:out param='${language}'/>"/></dt>
                                    ...
                                    <dt class="grid_3 alpha"><bbbl:label key="lbl_spc_gc_coveredAmt" language="<c:out param='${language}'/>"/></dt>
                                    <dd class="grid_1 textRight">
                                        <dsp:droplet name="CurrencyFormatter">
                                ...
                                <c:if test="${isOrderAmtCoveredVar == false}">
                                    <p class="combinePayment clearfix"><bbbl:label key="lbl_spc_gc_ccgc" language="<c:out param='${language}'/>"/></p>
                                </c:if>
                            </div>
                                    ...
                                    <div class="grid_8 highlightSection alpha omega">
                                        <div class="clearfix">
                                            <ul class="productsListHeader">
                                                <li class="grid_3"><bbbl:label key="lbl_spc_gc_gcNumber" language="<c:out param='${language}'/>"/></li>
                                                <li class="grid_1 alpha textRight"><bbbl:label key="lbl_spc_gc_used" language="<c:out param='${language}'/>"/></li>
                                                <li class="grid_2 textRight"><bbbl:label key="lbl_spc_gc_remainingBal" language="<c:out param='${language}'/>"/></li>
                                                        ...
                                                        <li>
                                                            ...
                                                            <div class="grid_1 textRight">
                                                             ...
                                                             <div class="grid_2 alpha omega textRight">
                                                                <dsp:a page="/checkout/singlePage/payment/billing_payment.jsp" title="Remove" iclass="remove" id="spRemoveGiftCard">
                                                                    <dsp:property bean="BBBGiftCardFormHandler.paymentGroupId" paramvalue="element.id"/>
                                                                    <dsp:property bean="BBBGiftCardFormHandler.spRemovePaymentGroup" value="true"/>
                                                                    <bbbl:label key="lbl_spc_gc_remove" language="<c:out param='${language}'/>"/> <span class="removeIcon"></span>
                                                                    <%--<bbbl:label key="lbl_spc_cartdetail_movetowishList" language="<c:out param='${language}'/>"/>--%>
                                                                </dsp:a>
                                        ...
                                        <dsp:oparam name="false">
                                            <div class="grid_8 alpha omega">
                                                <dsp:droplet name="Switch">
                                                    <dsp:param name="value" value="${isGiftcardsVar}"/>
                                                    <dsp:oparam name="true">
                                                        <h3 class="sectionHeading noBorder"><bbbl:label key="lbl_spc_gc_addGC" language="<c:out param='${language}'/>"/></h3>
                                                    </dsp:oparam>
                                                    <dsp:oparam name="false">
                                                        <h3 class="sectionHeading noBorder"><bbbl:label key="lbl_spc_gc_addGC_MCC" language="<c:out param='${language}'/>"/></h3>
                                                    </dsp:oparam>
                                                </dsp:droplet>
                                                <dsp:form id="frmPayWithGiftCard" iclass="clearfix flatform" action="${contextPath}/checkout/singlePage/payment/billing_payment.jsp?spcAddingGiftCard=true" method="post">
                                                    <%--<dsp:droplet name="Switch">
                                                    ...
                                                    <input type="hidden" name="spcAddingGiftCard" value="true" />

                                                    <div class="grid_2 alpha omega input marTop_5">
                                                        <label id="lblgiftCardNumberPWGC" for="giftCardNumberPWGC"><bbbl:label key="lbl_spc_gc_gcNumber" language="<c:out param='${language}'/>"/></label>
                                                        <div class="text">
                                                    ...
                                                    <div class="grid_2 input marTop_5 alpha omega padLeft_20">
                                                        <label id="lblgiftCardPinPWGC" for="giftCardPinPWGC"><bbbl:label key="lbl_spc_gc_gcPin" language="<c:out param='${language}'/>"/></label>
                                                        <div class="text">
                                                            ...
                                                            <%--
															<bbbl:label key="lbl_spc_payment_find_your_pin" language="<c:out param='${language}'/>"/>
                                                            --%>
                                                    ...
                                                    <div class="grid_2 input alpha padLeft_20">
                                                        <a class="popup" id="giftCardFindPin" href="/store/checkout/payment/find_your_pin.jsp" title="How to Find Your Pin">
                                                            <span class="icon-question-circle icon-font" aria-hidden="true"></span>
                                                        </a>
                                                            

                                                            <a href="#" id="checkBalance" onclick="javascript:omnitureExternalLinks('Value Link: Add a Gift Card-Check Balance Button ')">Check Card Balance</a>
                                                    ...
                                                    <div class="grid_2 alpha omega marBottom_10 marTop_15">
                                                        
                                                        <!--<dsp:input type="hidden" bean="BBBGiftCardFormHandler.giftCardSuccessURL" value="/checkout/singlePage/payment/billing_payment.jsp"/>
                                                        <dsp:input type="hidden" bean="BBBGiftCardFormHandler.giftCardErrorURL" value="/checkout/singlePage/payment/billing_payment.jsp"/>-->
                                                        <dsp:input bean="BBBGiftCardFormHandler.fromPage" type="hidden" value="billinggiftcard" />                                                         
                                                        <dsp:input type="submit" bean="BBBGiftCardFormHandler.spCreateGiftCard" value="Apply" iclass="btnPrimary button-Med">
                                                            <dsp:tagAttribute name="aria-pressed" value="false"/>
															<dsp:tagAttribute name="aria-label" value="Apply and Save your gift card information"/>
                                                    ...
                                                    <div class="cb clearfix giftCardBalanceWrap hidden marBottom_10">
                                                        ...
                                                        <div class="grid_2 alpha omega">
                                                            <label class="bal"><strong><bbbl:label key="lbl_spc_gc_bal" language="<c:out param='${language}'/>"/></strong> <span class="balance giftCardResultItem"></span></label>
                                                        </div>
                                                    </div>
                                                    
                                                </dsp:form>
                                                <dsp:form action="${contextPath}/checkout/singlePage/payment/billing_payment.jsp" method="post"  id="frmPayWithGiftCardHiddenForm" iclass="hidden">
