...
<dsp:droplet name="/com/bbb/selfservice/SearchStoreDroplet">
	...
	<dsp:oparam name="output">
		<li><strong>
			<bbbl:label key="lbl_spc_shipping_store_pickup" language="<c:out param='${language}'/>"/>
		</strong></li>
		<li class="smallText marTop_5">
			<bbbl:label key="lbl_spc_shipping_available_for_store_pickup" language="<c:out param='${language}'/>"/>
		</li>
		<li class="address">
		...
		<li class="marTop_5"><a href="#" class="upperCase marTop_5 changeStore"><strong>
			<bbbl:label key="lbl_spc_cartdetail_change" language="<c:out param='${language}'/>"/>
		</strong></a></li>
	</dsp:oparam>
</dsp:droplet>
