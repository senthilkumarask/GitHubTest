	          		...
	          		<div class="container_12 clearfix" id="content" role="main">
						...
						<div class="grid_9">
							<div class="grid_4 alpha" id="newCustomer">
								...
								<p class="bold"><bbbl:label key="lbl_spc_checkout_checkoutasguest" language="<c:out param='${language}'/>"/></p>
								...
								<div class="button button_active">
									<form id="guestCheckoutForm" action="${pageContext.request.contextPath}/checkout/shipping/shipping.jsp">
										<input type="submit" value="<bbbl:label key="lbl_spc_checkout_checkoutasguest" language="<c:out param='${language}'/>"/>" name="" id="CheckoutBtn" role="button" aria-pressed="false">
									</form>
								</div>
							</div>
