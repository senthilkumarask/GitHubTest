                    ...
                    <dsp:form id="addBillingAddress" name="form" method="post">
                        <fieldset class="radioGroup">
                                    ...
                                    <dsp:droplet name="ForEach">
                                        ...
                                        <dsp:oparam name="output">
                                            <div class="radioItem input clearfix">
                                                <div class="radio">
                                                    <dsp:input type="radio" paramvalue="element.id" bean="BBBSPBillingAddressFormHandler.userSelectedOption">
                            ...
                            <div class="radioItem input clearfix last">
                                <div class="radio">
                                    <dsp:input type="radio" bean="BBBSPBillingAddressFormHandler.userSelectedOption" value="NEW" >
                                        <dsp:tagAttribute name="aria-checked" value="false"/>
                                    </dsp:input>
                                </div>
                                <div class="label">
                            ...
                            <div class="subForm clearfix hidden">
                                <div class="fieldsInlineWrapper clearfix">
                                    ...
                                    <div class="input">
                                        ...
                                        <div class="text">
                                            <dsp:input type="text" bean="BBBSPBillingAddressFormHandler.billingAddress.firstName" required="true" id="firstName" >
                                    ...
                                    <div class="input">
                                        ...
                                        <div class="text">
                                            <dsp:input type="text" bean="BBBSPBillingAddressFormHandler.billingAddress.middleName" id="midleName" >
                                ...
                                <div class="input clearfix">
                                    ...
                                    <div class="text">
                                        <dsp:input type="text" bean="BBBSPBillingAddressFormHandler.billingAddress.lastName" required="true" id="lastName" >
                                            <dsp:tagAttribute name="aria-required" value="true"/>
                                ...
                                <div class="input clearfix">
                                    ...
                                    <div class="text">
                                        <div>
                                            <dsp:input type="text" bean="BBBSPBillingAddressFormHandler.billingAddress.companyName" >
                                                <dsp:tagAttribute name="aria-required" value="false"/>
                                            </dsp:input>
                                        </div>
                                    </div>
                                ...
                                <div class="fieldsInlineWrapper clearfix">
                                    ...
                                    <div class="input">
                                        ...
                                        <div class="text">
                                            <dsp:input type="text" bean="BBBSPBillingAddressFormHandler.billingAddress.address1" required="true" id="shippingAddress1" >
                                                <dsp:tagAttribute name="aria-required" value="true"/>
                                    ...
                                    <div class="input">
                                        ...
                                        <div class="text">
                                            <div class="text">
                                                <dsp:input type="text" bean="BBBSPBillingAddressFormHandler.billingAddress.address2" required="true" id="shippingAddress2" >
                                                    <dsp:tagAttribute name="aria-required" value="false"/>
                                ...
                                <div class="fieldsInlineWrapper clearfix">
                                    ...
                                    <div class="input">
                                        ...
                                        <div class="text">
                                            <dsp:input type="text" bean="BBBSPBillingAddressFormHandler.billingAddress.city" required="true" >
                                                <dsp:tagAttribute name="aria-required" value="true"/>
                                            </dsp:input>
                                        </div>
                                    </div>
                                    ...
                                    <div class="input">
                                        ...
                                        <div class="select">
                                            <dsp:select bean="BBBSPBillingAddressFormHandler.billingAddress.state" name="stateName" id="stateName">
                                                <dsp:tagAttribute name="aria-required" value="true"/>
                                ...
                                <div class="input clearfix">
                                    ...
                                    <div class="text">
                                        <dsp:input type="text" bean="BBBSPBillingAddressFormHandler.billingAddress.postalCode" name="postalCode" value="" id="zipCode" required="true" >
                                            <dsp:tagAttribute name="aria-required" value="true"/>
                                ...
                                <div class="checkboxItem input clearfix">
                                    <div>
                                        <dsp:input type="checkbox" bean="BBBSPBillingAddressFormHandler.saveToAccount" name="saveToAccount" value="TRUE" >
                        ...
                        <fieldset>
                            ...
                            <div class="subForm">
                                <div class="fieldsInlineWrapper clearfix">
                                    ...
                                    <div class="input">
                                        ...
                                        <div class="text">
                                            <dsp:input type="text" bean="BBBSPBillingAddressFormHandler.billingAddress.email" value="" id="email" required="true" >
                                                <dsp:tagAttribute name="aria-required" value="true"/>
                                ...
                                <div class="input">
                                    ...
                                    <div class="text">
                                        <dsp:input type="text" bean="BBBSPBillingAddressFormHandler.billingAddress.confirmedEmail" value="" id="emailConfirm" required="true" >
                                            <dsp:tagAttribute name="aria-required" value="true"/>
                            ...
                            <div class="grid_3 alpha clearfix">
                                ...
                                <div class="text">
                                    <dsp:input type="text" bean="BBBSPBillingAddressFormHandler.billingAddress.phoneNumber" value="" id="phoneNumber" required="true" >
                                        <dsp:tagAttribute name="aria-required" value="true"/>
                        ...
                        <div class="button btnApply">
                            <c:set var="lbl_button_next" scope="page">
                                <bbbl:label key="lbl_spc_billing_button_next" language="${pageContext.request.locale.language}" />
                            </c:set>

                            <dsp:input bean="BBBSPBillingAddressFormHandler.saveBillingAddress" type="submit" value="${lbl_button_next}" id="billingAddressNextBtn" >
