<dsp:page>
	...
	<dsp:getvalueof var="formExceptions" bean="BBBSPBillingAddressFormHandler.formExceptions"/>	
	

	<dsp:droplet name="IsEmpty">
		<dsp:param name="value" bean="BBBSPBillingAddressFormHandler.formExceptions"/>
