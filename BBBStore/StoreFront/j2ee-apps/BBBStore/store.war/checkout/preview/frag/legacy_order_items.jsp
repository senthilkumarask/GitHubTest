<dsp:page>
	...
	<ul class="productsListHeader">
		...
		<li class="grid_3 textRight yourPrice"><strong><bbbl:label key="lbl_you_pay" language="<c:out param='${language}'/>"/></strong></li>
			...
			<dsp:oparam name="output">
				<li>				
					...
					<dsp:getvalueof var="cartItemDetails" param="cartItemDetails" />
						...
						<dsp:include
							page="/checkout/preview/frag/legacy_order_Item_price.jsp"
							flush="true">							
	...
	<dsp:include
		page="/checkout/preview/frag/legacy_order_subtotal_details.jsp"
		flush="true">
	...
	<dsp:include
		page="/checkout/preview/frag/legacy_order_billing_details.jsp"
		flush="true">
