			...
			<c:if test="${not empty showLinks}">
				...
				<li class="clearfix shippingItemAddDetails">
					<div class="grid_5 alpha">
						<p class="padTop_5"><strong><bbbl:label key="lbl_preview_storelocation" language="<c:out param='${language}'/>"/></strong></p>
...
--%>
					...
					<dsp:getvalueof var="StoreDetailsVar" param="StoreDetails" scope="page"/>
						<p class="padTop_5"><strong><bbbl:label key="lbl_preview_storehours" language="<c:out param='${language}'/>"/></strong></p>
