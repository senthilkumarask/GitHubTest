<dsp:page>
	...
	<div class="grid_2 alpha">
		<p>
		<strong><bbbl:label key="lbl_preview_shippingaddress"
	...
	<div class="grid_3">
		<p>
			<strong><bbbl:label key="lbl_preview_shippingmethod" language="<c:out param='${language}'/>"/> </strong>
		</p>
		<dl class="noMar marTop_5">
			...
			<c:choose>
				<c:when test="${cartDetailInfo.VDSInCart eq 'false'}">
					<dt><bbbl:label key="lbl_preview_expecteddelivery" language="<c:out param='${language}'/>"/> </dt>
