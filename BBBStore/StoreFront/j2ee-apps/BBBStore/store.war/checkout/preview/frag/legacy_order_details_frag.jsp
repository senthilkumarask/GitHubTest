<dsp:page>
	...
	<c:set var="showLinks" scope="request">
		...
		<div class="grid_8" id="leftCol">
			<div>
				<h3 class="sectionHeading marTopNeg_24">
					${fn:length(cartDetailInfo.cartItemDetailList)}
					<bbbl:label key="lbl_preview_itemsshippingto"
...
<c:set var="trackingNumber"><dsp:valueof param="shipment.trackingNumber"/></c:set>
				...
				<ul class="shippingItemAddDetails marTop_10">
					<li class="clearfix"><dsp:include
							page="/checkout/preview/frag/legacy_order_shipping_address.jsp"
							flush="true">
							...
							page="/checkout/preview/frag/legacy_order_gift_wrap.jsp"
							flush="true">
			...
			<dsp:include page="/checkout/preview/frag/legacy_order_items.jsp"
				flush="true">
		...
		<div class="spclSectionBoxGreen">
			<div class="spclSection">
				<div class="bigPromoText">
					<h2>
						<bbbl:label key="lbl_preview_relax"
							language="<c:out param='${language}'/>" />
					</h2>
					<h2>
						<bbbl:label key="lbl_preview_nopressure"
							language="<c:out param='${language}'/>" />
					</h2>
					<h2>
						<strong><bbbl:label
								key="lbl_preview_returnsarepostagepaid"
								language="<c:out param='${language}'/>" />
						</strong>
					</h2>
				</div>
				<p>
					<bbbl:label key="lbl_preview_checkoutinfo"
						language="<c:out param='${language}'/>" />
				</p>
			</div>
		</div>
