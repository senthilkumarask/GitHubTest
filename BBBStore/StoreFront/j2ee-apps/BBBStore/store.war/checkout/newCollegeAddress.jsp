            ...
            <div class="input clearfix">
                ...
                <div class="text">
                    <div>
                        <c:choose>
                            <c:when test="${empty preFillValues || preFillValues}">
                              <dsp:input type="text" bean="BBBShippingGroupFormhandler.address.companyName" maxlength="40" name="college" id="college">
                                <dsp:tagAttribute name="aria-required" value="false"/>
                                <dsp:tagAttribute name="aria-labelledby" value="lblcompanyColg errorcompanyColg"/>
                              </dsp:input>
                            </c:when>
                            <c:otherwise>
                              <dsp:input type="text" bean="BBBShippingGroupFormhandler.address.companyName" maxlength="40" name="college" id="college" value="">
                                <dsp:tagAttribute name="aria-required" value="false"/>
                                <dsp:tagAttribute name="aria-labelledby" value="lblcompanyColg errorcompanyColg"/>
                              </dsp:input>
                            </c:otherwise>
                ...
                <div class="input">
                    ...
                    <div class="select noMar cb">
                        <c:choose>
                            ...
                            <c:otherwise>
								<dsp:select bean="BBBShippingGroupFormhandler.address.state" name="stateNameColg" id="stateNameColg" nodefault="true">
                                    <dsp:tagAttribute name="aria-required" value="true"/>
                                    <dsp:tagAttribute name="aria-labelledby" value="lblstateNameColg errorstateNameColg"/>
									<dsp:droplet name="StateDroplet">
										<dsp:oparam name="output">
