<dsp:page>
    ...
    <dsp:getvalueof var="reloadPage" param="reloadPage" />
	...
	<div class="grid_4 omega orderSummaryCont" id="rightCol">
		<input type="hidden" id="reloadPage" value="${reloadPage}"/>
        ...
        <div class="footNotes">
            <ol>
            	...
            	<c:if test="${displayShippingDisclaimer}">
            	<ol>
