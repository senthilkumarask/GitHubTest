    ...
    <div class="width_6 clearfix">
		...
		<dsp:form iclass="clearfix width_6" id="frmForgotEmail" method="post" action="${contextPath}/giftregistry/modals/forgot_password_registry.jsp">
			...
			<div class="formRow fl noMarBot clearfix width_6">
                ...
                <a href="#" role="link" title="<bbbl:label key='lbl_forgot_pwd_cancel' language='${pageContext.request.locale.language}'/>" class="close-any-dialog buttonTextLink"><bbbl:label key='lbl_forgot_pwd_cancel' language='${pageContext.request.locale.language}'/></a>
			</div>
