							...
							<div class="fl">
								<div class="clearfix">
									<label for="radioStoreAddressFav_1" class="storeAdd">
										...
										<c:if test="${currentSiteId ne 'BedBathCanada'}">
								...
								<div class="actionLinks">
									<p class="marTop_10"><a class="viewDirectionsNew" href="#"  data-storeid="${favouriteStoreId}"  title="Get Map & Directions"><bbbl:label key="lbl_Get_Map_Directions" language="${pageContext.request.locale.language}" /></a></p>
									<%-- 
						...
						<li class="column1">
							<div class="fl">
								...
								<label for="radioStoreAddress_<dsp:valueof param="count"/>" class="storeAdd">
									...
									<span class="miles">(<dsp:valueof param="StoreDetails.distance" /> km)</span>
									</c:when>
									<c:otherwise>
									<span class="miles">(<dsp:valueof param="StoreDetails.distance" /> <dsp:valueof param="StoreDetails.distanceUnit" />)</span>
									</c:otherwise>
							...
							<div class="actionLinks">
								...
								<p class="marTop_10"><a class="viewDirectionsNew" href="#"  data-storeid="${storeId}"  title="Get Map & Directions"><bbbl:label key="lbl_Get_Map_Directions" language="${pageContext.request.locale.language}" /></a></p>
								<%--
								<p class="marTop_10"><a class="viewDirections" href="#"><bbbl:label key='lbl_find_store_get_directions' language="${pageContext.request.locale.language}" /></a></p>
								<p class="marTop_10"><a class="viewOnMap" href="#"><bbbl:label key='lbl_find_store_view_on_map' language="${pageContext.request.locale.language}" /></a></p>
								--%>
