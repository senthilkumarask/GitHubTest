						...
						<li class="column3">	
						 <div class="ui-dialog-buttonset">
							<div class="button button_active">
								...
								<input type="submit" value="Select Store" name="regchangeStoreBtn" id="regchangeStoreBtn" />
							</div>
						 </div>
						</li>
					</ul>
		...
		<div class="clearfix marTop_10">
			...
			<div class="width_3 fl marLeft_10 viewMorePrevLinks">
				...
				<c:if test="${currentPage gt 1}">
					<dsp:getvalueof id="pageKey" param="StoreDetailsWrapper.pageKey" />
					<dsp:a href="${contextPath}/giftregistry/modals/simReg_store_info.jsp" iclass="marRight_5 changeStoreDataPageLink">
				...
				<c:if test="${currentPage lt totalPageCount}">
					<dsp:getvalueof id="pageKey" param="StoreDetailsWrapper.pageKey" />
					<dsp:a href="${contextPath}/giftregistry/modals/simReg_store_info.jsp" iclass="marLeft_20 changeStoreDataPageLink">
						<dsp:param name="pageKey" value="${pageKey}" />
