                                    ...
                                    <div class="text">
                                        <div class="grid_2 alpha" aria-live="assertive">
                                            <dsp:input tabindex="1" 
                                                bean="SimplifyRegFormHandler.registryVO.event.eventDate"
                                ...
                                <div class="inputField clearfix" id="showerDate">
                                    ...
                                    <div class="text">
                                        <div class="grid_2 alpha">
                                            <dsp:input tabindex="2" bean="SimplifyRegFormHandler.registryVO.event.showerDate"
                                        ...
                                        <div class="grid_2 alpha">
                                            <dsp:droplet name="BBBConfigKeysDroplet">
                                                ...
                                                <dsp:oparam name="output">
                                                    ...
                                                    <dsp:select tabindex="3" bean="SimplifyRegFormHandler.registryVO.event.babyGender"  id="selRegistryGender" iclass="uniform"> 
                										<dsp:tagAttribute name="aria-required" value="false"/>
                                    ...
                                    <div class="text">
                                        <div class="grid_2 alpha">
                                            <dsp:input tabindex="4" 
                                                bean="SimplifyRegFormHandler.registryVO.event.babyName"
                                    ...
                                    <div class="textarea">
                                        <div class="grid_4 alpha">
                                            ...
                                            <dsp:textarea tabindex="5" 
                                                bean="SimplifyRegFormHandler.registryVO.event.babyNurseryTheme" id="txtRegistryTheme"><c:out value="${regVO.event.babyNurseryTheme}" /></dsp:textarea>
                                        </div>
                                    </div>
                                   
                                </div>
                                <%-- Step 1 baby registry hidden fields --%>
                                 <dsp:input bean="SimplifyRegFormHandler.registryVO.event.college" type="hidden"  value="" />
                      			 <dsp:input bean="SimplifyRegFormHandler.registryVO.event.guestCount" type="hidden"  name="txtRegistryNumberOfGuestsName" value="" />
                      			 <dsp:input bean="SimplifyRegFormHandler.registryVO.event.birthDate"  type="hidden" name="txtBirthdayDateName" value="" />
                                <div class="clear"></div>
                            </div>
                            <div class="clear"></div>
                    ...
                    <div id="step1FormPost" class="grid_12 alpha omega form post clearfix padTop_10">
                        <fieldset class="grid_8 alpha clearfix">
                            ...
                            <div class="registryForm">
                                    ...
                                    <div class="text">
                                        <div class="grid_2 alpha">
                                            <dsp:input tabindex="2" 
                                                bean="SimplifyRegFormHandler.registryVO.event.college"
                             ...
                             <dsp:input bean="SimplifyRegFormHandler.registryVO.event.babyName"  type="hidden"  value="" />
                      		 <dsp:input bean="SimplifyRegFormHandler.registryVO.event.guestCount" type="hidden"  name="txtRegistryNumberOfGuestsName" value="" />
							 <dsp:input bean="SimplifyRegFormHandler.registryVO.event.birthDate"  type="hidden"   name="txtBirthdayDateName" value="" />
							 <dsp:input bean="SimplifyRegFormHandler.registryVO.event.showerDate" type="hidden"  name="txtShowerDateName" value=""/>
							 <dsp:input bean="SimplifyRegFormHandler.registryVO.event.babyGender"  type="hidden" value="" /> 
							 <dsp:input bean="SimplifyRegFormHandler.registryVO.event.babyNurseryTheme" type="hidden"  value=""/>
                                <div class="clear"></div>
                            </div>
                            <div class="clear"></div>
                             <c:if test="${empty regVO}">
                        ...
                        <fieldset class="grid_8 alpha clearfix">
                            ...
                            <div class="registryForm">
                                ...
                                <div class="inputField clearfix" id="guestCount" >
                                    ...
                                    <div class="text">
                                        ...
                                        <dsp:getvalueof var="guestCount" value="${regVO.event.guestCount}"/>
                                            ...
                                            <dsp:input tabindex="2" 
                                                bean="SimplifyRegFormHandler.registryVO.event.guestCount" iclass="required digits"
                                ...
                                <div class="inputField clearfix" id="showerDate">
                                    ...
                                    <div class="text">
                                        <div class="grid_2 alpha">
                                            <dsp:input tabindex="3" bean="SimplifyRegFormHandler.registryVO.event.showerDate"
                                                type="text" id="txtRegistryDate${CADate}" name="txtShowerDateName" value="${regVO.event.showerDate}">
                                                <dsp:tagAttribute name="aria-required" value="true"/>
                                                <dsp:tagAttribute name="aria-labelledby" value="lbltxtRegistryDate${CADate} errortxtRegistryDate${CADate}"/>
                                            </dsp:input>
                                ...
                                <c:if test="${siteId == 'BuyBuyBaby'}">
                                    <div id="birthdayDate" class="inputField clearfix">
                                        ...
                                        <div class="text">
                                            <div class="grid_2 alpha">
                                                <dsp:input tabindex="2" 
                                                    bean="SimplifyRegFormHandler.registryVO.event.birthDate"
                                        ...
                                        <div class="text">
                                        	...
                                        	<c:if test="${regVO.event.guestCount eq '0'}">
                                                ...
                                                <dsp:input tabindex="3" 
                                                    bean="SimplifyRegFormHandler.registryVO.event.guestCount" iclass="digits"
