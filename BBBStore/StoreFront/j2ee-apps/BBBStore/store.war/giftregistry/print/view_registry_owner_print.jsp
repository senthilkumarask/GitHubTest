...
<meta charset="utf-8"/>
	...
	<c:choose>
		<c:when test="${not empty currentSiteId && currentSiteId eq BuyBuyBabySite}">
	...
	<script type="text/javascript" src="${jsPath}/_assets/global/js/jquery-1.7.1.min.js"></script>
	...
	<style type="text/css">
		...
		* {
		...
		.registryTableGifts td {
			background-color: #273791;
		}
		.registryTableGifts span {
			color: #FFFFFF;
			float: left;
			font-size: 17px;
			font-weight: bold;
		...
		.registryTableGifts .number {
			font-size: 32px;
			padding-right: 5px;
		}
		.registryTableGifts .text {
		padding-top: 6px;
		}
		.registryTableDetail table,
		.registryTableGifts table,
		...
		.registryTableDetail table th,
		.registryTableDetail table td,
		.registryTableGifts table th,
		.registryTableGifts table td,
		...
		.reg-detail-heading .number {
			color: #EE008C;
			font-size: 28px;
		}
		.reg-detail-heading .text {
			font-size: 17px;
			line-height: 33px;
		}
		...
		.bb .registryTableDetail,
		.bb .registryTableBaby,
		.bb .registryTableBridal,
		.bb .reg-content,
		.bb .reg-prod-image,
		...
		.br .registryTableDetail,
		.br .registryTableBaby,
		.br .registryTableBridal,
    ...
    font-weight: bold;
		...
		.registryTableBaby table td span{font-weight:bold;  word-wrap:break-word !important; float:left; width:140px}
	</style>
</head>
<body id="themeWrapper" class="${themeName} ${weddingTheme}" onload="javascript:window.print(); return false;">
	...
	<div id="pageWrapper" class="${pageWrapper}">
				...
				<dsp:oparam name="output">
					...
					<c:choose>
						<c:when test="${eventType eq  eventTypeParam}">
							<h1 class="padTop_10 padBottom_10 bold"><bbbl:label key='lbl_mng_regitem_wcback' language="${pageContext.request.locale.language}" />
								<dsp:droplet name="IsEmpty">
									<dsp:param param="registrySummaryVO.coRegistrantFirstName" name="value"/>
									<dsp:oparam name="false">
										${primaryRegistrantFirstName}&nbsp;<bbbl:label key='lbl_mng_regitem_and' language="${pageContext.request.locale.language}" />&nbsp;${coRegistrantFirstName}!
									</dsp:oparam>
							...
							<div class="registryTableDetail padTop_10 padBottom_10">
								<table width="100%" cellpadding="0" cellspacing="0" border="0">
									<tr>
										<td class="textLeft">
											<p class="padBottom_10 reg-detail-heading">
																...
																<dsp:droplet name="Switch">
																	...
																	<dsp:oparam name="true">
																		...
																		<c:when test="${not empty currentSiteId && currentSiteId eq BuyBuyBabySite}">
																			...
																			<c:when test="${not empty eventType && eventType eq 'Baby'}">
																				<span class="number bold"><dsp:valueof param="daysToGo"/></span>&nbsp;
																				<span class="text bold"><bbbl:label key='lbl_regflyout_daystogo_baby_arrives' language="${pageContext.request.locale.language}" /></span>
																			</c:when>
																			<c:when test="${not empty eventType && eventType eq 'Birthday'}">
																				<span class="text bold"><bbbl:label key='lbl_regflyout_daystogo_only' language="${pageContext.request.locale.language}" /></span>&nbsp;<span class="number bold"><dsp:valueof param="daysToGo"/></span>&nbsp;
																				<span class="text bold"><bbbl:label key='lbl_regflyout_daystogo_daystogo' language="${pageContext.request.locale.language}" /></span>
																			</c:when>
																			</c:choose>
																		</c:when>
																		<c:otherwise>
																			...
																			<c:when test="${not empty eventType && eventType eq 'Wedding'}">
																				<span class="number bold"><dsp:valueof param="daysToGo"/></span>&nbsp;<span class="text bold"><bbbl:label key='lbl_regflyout_daystogo_day_until_wedding' language="${pageContext.request.locale.language}" /></span>
																			</c:when>
																			<c:when test="${not empty eventType && eventType eq 'Baby'}">
																				<span class="number bold"><dsp:valueof param="daysToGo"/></span>&nbsp;<span class="text bold"><bbbl:label key='lbl_regflyout_daystogo_day_until_baby' language="${pageContext.request.locale.language}" /></span>
																			</c:when>
																	...
																	<dsp:oparam name="false">
																		...
																		<c:when test="${not empty currentSiteId && currentSiteId eq BuyBuyBabySite}">
																			<c:choose>
																			<c:when test="${not empty eventType && eventType eq 'Baby'}">
																				<span class="number bold"><dsp:valueof param="daysToGo"/></span>&nbsp;<span class="text bold"><bbbl:label key='lbl_regflyout_daystogo_days_since_life' language="${pageContext.request.locale.language}" /></span>
																			</c:when>
																			<c:when test="${not empty eventType && eventType eq 'Birthday'}">
																				<dsp:getvalueof var="daysToNextCeleb" param="daysToNextCeleb" />
																				<span class="number bold">${daysToNextCeleb}</span>&nbsp;<span class="text bold"><bbbl:label key='lbl_regflyout_daystogo_days_next_celeb' language="${pageContext.request.locale.language}" /></span>
																			</c:when>
																			</c:choose>
																		</c:when>
																		<c:otherwise>
																			<c:choose>
																			<c:when test="${not empty eventType && eventType eq 'Wedding'}">
																				<span class="text bold"><bbbl:label key='lbl_regflyout_daystogo_day' language="${pageContext.request.locale.language}" /></span> &nbsp;<span class="number bold"><dsp:valueof param="daysToGo"/></span>&nbsp;
																				<span class="text bold"><bbbl:label key='lbl_regflyout_daystogo_happy_ever_after' language="${pageContext.request.locale.language}" /></span>
																			</c:when>
																			<c:when test="${not empty eventType && eventType eq 'Baby'}">
																				<span class="number bold"><dsp:valueof param="daysToGo"/></span>&nbsp;<span class="text bold"><bbbl:label key='lbl_regflyout_daystogo_days_since_life' language="${pageContext.request.locale.language}" /></span>
																			</c:when>
																			...
																			<c:when test="${not empty eventType && eventType eq 'Retirement'}">
																				<span class="text bold"><bbbl:label key='lbl_regflyout_daystogo_day' language="${pageContext.request.locale.language}" /></span> &nbsp;<span class="number bold"><dsp:valueof param="daysToGo"/></span>&nbsp;
																				<span class="text bold"><bbbl:label key='lbl_regflyout_daystogo_rest_of_life' language="${pageContext.request.locale.language}" /></span>
																			</c:when>
																			<c:when test="${not empty eventType && eventType eq 'Anniversary'}">
																				<dsp:getvalueof var="daysToNextCeleb" param="daysToNextCeleb" />
																				<span class="number bold">${daysToNextCeleb}</span>&nbsp;<span class="text bold"><bbbl:label key='lbl_regflyout_daystogo_another_year' language="${pageContext.request.locale.language}" />*</span>
																			</c:when>
																			<c:when test="${not empty eventType && eventType eq 'Housewarming'}">
																				<span class="text bold"><bbbl:label key='lbl_regflyout_daystogo_day' language="${pageContext.request.locale.language}" /></span> &nbsp;<span class="number bold"><dsp:valueof param="daysToGo"/></span>&nbsp;
																				<span class="text bold"><bbbl:label key='lbl_regflyout_daystogo_new_place' language="${pageContext.request.locale.language}" /></span>
																			</c:when>
																			<c:otherwise>
											...
											<p>Registry#:&nbsp;<span class="bold">${registryId}</span></p>
										</td>
										<td class="textLeft address breakWord">
											<p class="noMar padBottom_10"><bbbl:label key='lbl_mng_regitem_currshpadd' language="${pageContext.request.locale.language}" /></p>
											<p class="noMar bold">
												<dsp:valueof param="registrySummaryVO.shippingAddress.addressLine1"/> <br>
												<dsp:getvalueof var="shipAddr2" param="registrySummaryVO.shippingAddress.addressLine2"/>
												<c:if test="${not empty shipAddr2}">${shipAddr2}<br> </c:if>
												<dsp:valueof param="registrySummaryVO.shippingAddress.city"/><br>
												<dsp:valueof param="registrySummaryVO.shippingAddress.state"/>, <dsp:valueof param="registrySummaryVO.shippingAddress.zip"/>
											</p>
										</td>
										<dsp:droplet name="IsEmpty">
											<dsp:param param="registrySummaryVO.futureShippingDate" name="value"/>
											<dsp:oparam name="false">
												<td class="textLeft address breakWord">
													<p class="noMar padBottom_10"><bbbl:label key='lbl_mng_regitem_futshpadd' language="${pageContext.request.locale.language}" /></p>
													<p class="noMar bold">
														<dsp:valueof param="registrySummaryVO.futureShippingAddress.addressLine1"/> <br>
														<dsp:getvalueof var="futureShipAddr2" param="registrySummaryVO.futureShippingAddress.addressLine2"/>
														<c:if test="${not empty futureShipAddr2}">${futureShipAddr2}<br> </c:if>
														<dsp:valueof param="registrySummaryVO.futureShippingAddress.city"/><br>
														<dsp:valueof param="registrySummaryVO.futureShippingAddress.state"/>, <dsp:valueof param="registrySummaryVO.futureShippingAddress.zip"/>
													</p>
													<p class="noMar padTop_10">Effective Date:&nbsp;<span class="bold"><dsp:valueof param="futureShippingDate"/></span></p>
												</td>
											</dsp:oparam>
										</dsp:droplet>
									</tr>
							...
							<c:choose>
								<c:when test="${eventTypeCode ne 'BA1' }">
									<div class="registryTableBridal padBottom_10">
										<table width="100%" cellpadding="0" cellspacing="0" border="0">
											<tr>
												<th class="textLeft">Registry Type</th>
												<th class="textLeft">Event Date</th>
											</tr>
											<tr>
								...
								<c:otherwise>
									<div class="registryTableBaby padBottom_10">
										<table width="100%" cellpadding="0" cellspacing="0" border="0">
											<tr>
												<th class="textLeft">Registry Type</th>
												<th class="textLeft">Baby's Expected Arrival Date</th>
												<th class="textLeft">Shower Date</th>
												<th class="textLeft"><bbbl:label key='lbl_mng_regitem_baby_name' language="${pageContext.request.locale.language}" /></th>
												<th class="textLeft">Baby Gender</th>
												<th class="textLeft"><bbbl:label key='lbl_mng_regitem_nursery_theme' language="${pageContext.request.locale.language}" /></th>
											</tr>
											<tr>
												<td class="textLeft bold"><span>${eventType}</span></td>
												<td class="textLeft bold"><span>${eventDate}</span></td>
												<td class="textLeft bold"><span>
													<c:if test="${not empty babyShowerDate}">
														<dsp:valueof param="registrySummaryVO.eventVO.showerDateObject" converter="date" date="MM/dd/yyyy"/>
													</c:if></span>
												</td>
												<td class="textLeft bold breakWord"><span><c:if test="${not empty babyName}">${babyName}</c:if></span></td>
												<td class="textLeft bold"><span>
												...
												<td class="textLeft bold breakWord"><span><c:if test="${not empty babyNurseryTheme}">${babyNurseryTheme}</c:if></span></td>
											</tr>
										</table>
									</div>
								</c:otherwise>
							...
							<div class="registryTableGifts padBottom_10">
								<table width="100%" cellpadding="0" cellspacing="0" border="0">
									<tr>
										<td class="textLeft"><span class="number"><dsp:valueof param="registrySummaryVO.giftRegistered"/></span><span class="text"><bbbl:label key='lbl_mng_regitem_giftswant' language="${pageContext.request.locale.language}" /></span></td>
										<td class="textLeft"><span class="number"><dsp:valueof param="registrySummaryVO.giftPurchased"/></span><span class="text"><bbbl:label key='lbl_mng_regitem_giftsgetting' language="${pageContext.request.locale.language}" /></span></td>
										<td class="textLeft"><span class="number"><dsp:valueof param="registrySummaryVO.giftRemaining"/></span><span class="text"><bbbl:label key='lbl_mng_regitem_giftsrem' language="${pageContext.request.locale.language}" /></span></td>
									</tr>
								</table>
							</div>
							...
							<dsp:droplet name="RegistryItemsDisplayDroplet">
								...
								<dsp:oparam name="output">
									<c:choose>
										...
										<c:otherwise>
											<c:if test="${(empty sortSeq) || sortSeq ==1}">
												<%-- For Each Droplet for normal Categories list --%>
																																...
																																<td class="reg-prod-info-inner">
																																	<table width="100%" cellpadding="0" cellspacing="0" border="0">
																																		<tr class="reg-prod-header">
																																			...
																																			<th class="reg-prod-qty textCenter"><bbbl:label key='lbl_mng_regitem_purchased' language="${pageContext.request.locale.language}" /></th>
																																		...
																																		<tr class="reg-prod-content">
																																			...
																																			<td class="reg-prod-qty textCenter reg-prod-content-extrapad">${purchasedQuantity}</td>
												...
												<%-- For Each Droplet for other Categories list--%>
												<dsp:droplet name="ForEach">
														<dsp:param name="array" param="categoryBuckets" />
														<dsp:param name="sortProperties" value="+_key" />
														<dsp:oparam name="output">
											...
											<c:if test="${(not empty sortSeq) && sortSeq ==2}">
											<%-- For Each Droplet for price range list --%>
												<dsp:droplet name="ForEach">
		...
		<div id="footer" class="cb textCenter">
