...
<dsp:form id="frmEmailRegistry">
 ...
 <%--    <c:url var="successUrlVar" value="../frags/registry_items_owner.jsp">
    ...
    <dsp:input bean="GiftRegistryFormHandler.queryParam"  type="hidden" value="registryId=${param.registryId}" />
    <dsp:input bean="GiftRegistryFormHandler.fromPage" type="hidden" value="emailafriendforminputs" />
