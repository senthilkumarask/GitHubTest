...
<label id="selectRegistryFlyout"><bbbl:label key="lbl_select_registry_type" language ="${pageContext.request.locale.language}"/></label>
   <div class="createRegistry selectTypeFOR">
		
		<dsp:select  bean="GiftRegistryFormHandler.registryEventType"  iclass="selector_primary selectRegToCreate" id="selectregistry">	
