								...
								<dsp:oparam name="output">
									...
									<li class="clearfix productRow btngiftViewTopMargin giftViewProductChangeStoreWrapper addToCartGiftRegWrapper">
										...
										<div class="productContainer">
											<div class="productTab productHeading">
											...
											<div class="productTab productContent clearfix">
												...
												<div class="requested bold"><dsp:valueof param="regItem.qtyRequested" /></div>
												<div class="purchase bold"><dsp:valueof param="regItem.qtyPurchased" /></div>
																		...
																		<dsp:oparam name="output">
																			...
																			<c:choose>
											                          			<c:when test="${currentCount%2 == 0}">
															            			<div <c:if test="${fn:contains(actionURL,'ltlDeliveryInfo') }">class="ltlTruck"</c:if>><dsp:valueof param="attributeVO.attributeDescrip" valueishtml="true"/></div>
