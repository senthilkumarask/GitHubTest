...
<dsp:form method="post" action="index.jsp" id="frmRegistryProduct">
	...
	<div class="clearfix space sorting giftViewSortingControls padBottom_10">
		...
		<div class="grid_4 fr right omega">
			<ul>
				...
				<li>
					...
					<label id="lblpurchased" for="purchased"><bbbl:label key='lbl_mng_regitem_purchased_sort' language="${pageContext.request.locale.language}" /></label>
				</li>
				<li>
				...
				<li>
					...
					<label id="lblpurchased" for="Remaining"><bbbl:label key='lbl_mng_regitem_remaining' language="${pageContext.request.locale.language}" /></label>
				</li>
				</c:if>
			</ul>
		</div>
