...
<dsp:getvalueof bean="SessionBean.ownerRegAddPOBOX" var="isPOBoxAddress"/>
	...
	<dsp:droplet name="ForEach">
					<dsp:param name="array" param="registryItemList" />
									...
									<li class="grid_12 alpha clearfix productRow btngiftViewTopMargin giftViewProductChangeStoreWrapper addToCartGiftRegWrapper<c:if test="${inCartFlagSKU}"> inCartContainer</c:if>">
	                                             			...
	                                             			<c:when test="${not empty refNum}">
	                                             				<c:choose>
	                                             					<c:when test="${not empty personalizedImageUrlThumbs}">
	                                             						<img src="${personalizedImageUrlThumbs}" height="146" width="146" alt="<c:out value='${productName}'/>" class="prodImage" onerror="this.src = '${imagePath}/_assets/global/images/no_image_available.jpg';" >
	                                             					</c:when>
										...
										<div class="productContainer grid_10 omega">
											...
											<div class="productTab productContent clearfix">
												...
												<div class="purchase">
													<span class="columnHeader"><bbbl:label key='lbl_mng_regitem_purchased' language="${pageContext.request.locale.language}" /></span><span class="columnHead" tabindex="0" style="font-family: 'ITCNewBaskervilleRoman';color: #666;font-size: 18px;" aria-label="Purchased:<dsp:valueof param="regItem.qtyPurchased" />">
