	...
	<ul class="productDetailList giftViewProduct">
							...
							<c:otherwise>
								...
								<span class="prodReviews metaFeedback">
                                    ...
                                    <span class="ratingsReviews ratingTxt"><span class="ariaLabel">${ratingsTitle}</span> </span><span class="reviewTxt writeReview"><a href="${contextPath}${finalUrl}?categoryId=${CategoryId}&writeReview=true" title="${writeReviewLink}" role="link" aria-label="${writeReviewLink} ${lblAboutThe} ${productName}">${writeReviewLink}</a></span>
								</span>
							</c:otherwise>
                            ...
                            <c:if test="${comment!='null'}">
                              <div class="recommendation_message">
										...
										<div class="note_icon">
											<span class="recommendation_note_icon"></span></div>
										<div>
