<dsp:page>
	...
	<c:set var="pageTypeForCanonicalURL" value="ShopTheLook" scope="request" />
		...
		<div id="content" class="container_12 clearfix topConsultantsPicks" role="main">		
        	...
        	<div class="grid_12 topPicksHeader">
                ...
                <div class="grid_9 alpha">
                       <h1 class="txtOffScreen"><bbbl:label key="lbl_shop_look_main_header" language="${pageContext.request.locale.language}" /></h1>
           ...
           <dsp:droplet name="/atg/dynamo/droplet/Cache">
		                  <dsp:param name="key" value="${param.id}_${appid}_${param.eventType}_${isTransient}" />
			...
			<dsp:oparam name="output">
		        ...
		        <dsp:getvalueof var="heroImageAltAttr" value="${kickStarterVO.heroImageAltAttr}"/>	
           	...
           	<div class="grid_12 shopLookMainImageWrap">           		
                ...
                <img class="shopLooksMainImage" src="${imagePath}?wid=953&hei=493" width="953" height="493" alt="${heroImageAltAttr}"/>
           	</div>
           	...
           	<div class="grid_12 shopLooksDetails">
                <div class="grid_7 alpha">
					...
					<div class="grid_3 alpha omega createRegistryorAddAll <c:if test='${isInternationalCustomer}'>button_disabled</c:if>">
	                	<c:choose>
			...
			<span class="incDec visuallyhidden" aria-live="assertive" aria-atomic="true"></span>
           	...
           	<div class="grid_12 clearfix spacing spacingBottom" style="margin-top: 40px;"> 
				<dsp:include page="/giftregistry/frags/registry_promo_boxes.jsp">	
           		...
           		<c:set var="omniDesc" value="Popular Items -${heading1}"/>				
