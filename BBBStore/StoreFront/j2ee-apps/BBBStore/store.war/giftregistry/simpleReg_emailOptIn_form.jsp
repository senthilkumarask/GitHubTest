	...
	<dsp:getvalueof var="currentSiteId" bean="/atg/multisite/Site.id" />
	 <dsp:getvalueof var="babyCA" bean="SessionBean.babyCA"/>
	 	 <dsp:getvalueof var="formExceptions" bean="GiftRegistryFormHandler.formExceptions"/>
              ...
              <label id="lbloptIn" for="optIn" class="textDgray11 wrapTextAfterCheckBox emailSubs grid_3"><bbbl:label key="lbl_email_optin_bedbath_canada" language="${pageContext.request.locale.language}"/></label>
            </div>
           </c:when>
            <%-- Baby Canada --%>
	            <c:otherwise>
