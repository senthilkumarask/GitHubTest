			...
			<fieldset class="pagControls clearfix">
				<div class="pagSort">
					...
					<ul class="pagLevel1UL">
						<li class="listCount">
							<strong><bbbl:label key='lbl_regcreate_mxshowing' language="${pageContext.request.locale.language}" /> 
								<c:choose>
							...
							<span>o ${totalCount} Registros</span>
							<h3 class="txtOffScreen">
								<bbbl:label key='lbl_regcreate_mxshowing' language="${pageContext.request.locale.language}" /> 
								<c:choose>
									<c:when test="${totalCount > perPage}">
										<c:if test="${pagNum eq total}">
											<c:set var="upperRange" value="${totalCount}"/>
				...
				<div class="pagFilter">
					<ul class="pagLevel1UL">  
						<li class="listFilter"> 
							<strong><bbbl:label key='lbl_regsrchguest_mxperpage' language="${pageContext.request.locale.language}" /></strong>&nbsp;
