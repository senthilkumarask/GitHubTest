...
<dsp:getvalueof var="title" bean="EmailHolder.values.title"/>
	...
	<dsp:form id="frmEmailAFriend" name="frmEmailAFriend" method="post">
		...
		<fieldset>
		<legend class="hidden">email a fiend</legend>
			...
			<dsp:input bean="${formHandler}.successURL" type="hidden" value="/store/mx/_includes/modules/email_friend_confirm.jsp"/>
			...
			<div class="input clearfix formRow marTop_10">
				<div class="label width_2 fl">
					<label id="lblfrndEmail" for="frndEmail"><bbbl:label key="lbl_mxemail_friend" language ="${pageContext.request.locale.language}"/> <span class="required">*</span></label>
				</div>
				...
				<div class="fl frndEmailInfoTxt">
					<bbbl:textArea key="txt_mxemail_tofriend_instruct" language ="${pageContext.request.locale.language}"/>
				</div>				
			</div>

			<div class="input clearfix formRow">
				<div class="label width_2 fl">
					<label id="lblyourEmail" for="yourEmail"><bbbl:label key="lbl_mxemail_sender" language ="${pageContext.request.locale.language}"/><span class="required">*</span></label>
				</div>
			...
			<div class="input clearfix formRow">
				<div class="label width_2 fl">
					<label for="comments"><bbbl:label key="lbl_mxemail_comments" language ="${pageContext.request.locale.language}"/> </label>
				</div>
			...
			<div id="captchaDiv" class="clearfix noMarTop">
				<div class="input clearfix">
					<div class="label width_2 fl">
						<label id="lblcaptchaAnswer" for="captchaAnswer">C&oacute;digo de seguridad <span class="required">*</span></label>
					</div>
				...
				<div class="checkEmailFriend clearfix">
                    <div class="checkbox fl">
                        <dsp:input id="emailPromotions" type="checkbox"
                                name="emailPromotions" checked="true" iclass="marRight_5"
                    ...
                    <div class="label fl">
                        <label id="lblemailPromotions" for="emailPromotions"><bbbl:label key="lbl_mxemail_checkbox_copy_email" language ="${pageContext.request.locale.language}"/></label>
                    </div>
                    <div class="clear"></div>
				</div>
			</div>
			...
			<div class="ui-dialog-buttonset">
				<div class="button button_active">
					...
					<dsp:input type="Submit" bean="${formHandler}.${handlerName}" value="Enviar" id="btnSubmit">
					<dsp:tagAttribute name="aria-pressed" value="false"/>
                        <dsp:tagAttribute name="aria-labelledby" value="btnSubmit"/>
                        <dsp:tagAttribute name="role" value="button"/>
                    </dsp:input>
				</div>
                <a class="buttonTextLink close-any-dialog" href="#" role="link">Cancelar</a>
			</div>
		</div>
		</fieldset>
