<dsp:page>
	...
	<div title="Create Registry">
		<dsp:form name="createRegisDialogForm" id="createRegisDialogForm">
			<p><bbbl:label key="lbl_regcreate_new_registry" language ="${pageContext.request.locale.language}"/></p>
			<div class="width_2">
			
			<dsp:select
										bean="GiftRegistryFormHandler.registryEventType"
										id="registeryType"  name="registeryType">
			...
			<div class="marTop_5">
				...
				<label id="lblregisteryType" class="offScreen"><bbbl:label key="lbl_regcreate_new_registry" language ="${pageContext.request.locale.language}"/></label>
			</div>
			<bbbt:textArea key="txt_createreg_promos" language ="${pageContext.request.locale.language}"/>
			...
			<div class="ui-dialog-buttonset">
				...
				<dsp:input id="submitClick"	bean="GiftRegistryFormHandler.registryTypes" type="button" name="createRegisteryBtn" iclass="createRegFromModal" value="${submitBtn}">
		...
		value="/store/giftregistry/simpleReg_creation_form.jsp" /> --%>
		</div>
			</div>
		</dsp:form>
	</div>
