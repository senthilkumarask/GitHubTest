 ...
 *
 *  FILE:  ReclaimAccountResponseVO.java
 *
 *  DESCRIPTION: ReclaimAccountResponseVO : Response VO for reclaim account web service  
 *  HISTORY:
...
public class ReclaimAccountResponseVO extends ServiceResponseBase{
