 ...
 *
 *  FILE:  VerifyAccountReqVO.java
 *
 *  DESCRIPTION: VerifyAccountReqVO : Request VO for verify account web service  
 *  HISTORY:
...
public class VerifyAccountReqVO extends ServiceRequestBase{
