...
public class OrderHistory2ResVO extends ServiceResponseBase implements Comparable<OrderHistory2ResVO> {
	/**
	 * 
	 */
	...
	public boolean isWsOrder() {
		return wsOrder;
	}
	public void setWsOrder(boolean wsOrder) {
	...
	@Override
	public int compareTo(OrderHistory2ResVO pO1) {
