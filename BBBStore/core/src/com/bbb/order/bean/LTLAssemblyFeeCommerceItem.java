...
/**
 * Holder for LTLAssemblyCommerceItem.
 * @author ATG
 * @version $Revision: #1 $
 */
public class LTLAssemblyFeeCommerceItem extends NonMerchandiseCommerceItem {

	/**
	 * 
	 */
	private static final long serialVersionUID = -5428460456942369245L;
