...
/**
 * The Class CustomerSddVOReq.
 *
 * @author 
 */
public class CustomerSddVOReq implements Serializable{
...
public String toString(){
		...
		StringBuffer customerSddVOReq = new StringBuffer("");
		customerSddVOReq.append("first_name: "+this.first_name + "|");
		customerSddVOReq.append("last_name: "+this.last_name + "|");
		customerSddVOReq.append("business_name: "+this.business_name + "|");
		customerSddVOReq.append("phone: "+this.phone + "|");
		customerSddVOReq.append("email: "+this.email + "|");
		customerSddVOReq.append("address_line_1: "+this.address_line_1 + "|");
		customerSddVOReq.append("address_city: "+this.address_city + "|");
		customerSddVOReq.append("address_state: "+this.address_state + "|");
		customerSddVOReq.append("address_zipcode: "+this.address_zipcode + "|");
		return customerSddVOReq.toString();
