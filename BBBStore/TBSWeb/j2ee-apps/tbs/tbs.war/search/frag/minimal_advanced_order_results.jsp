<dsp:page>
    ...
    <c:if test="${empty perPage}">
	 ...
	 <dsp:getvalueof bean="TBSAdvancedOrderSearchResultsCacheBean.outputMinimalOrders" var="orderMap"/>
	 <dsp:getvalueof var="orders" value="${orderMap[searchKey]}"/>
	...
	<%-- <dsp:getvalueof var="ordersSize" value="${fn:length(orders)}"/>
	  <c:if test="${totalOrers gt ordersSize}">
	 	<dsp:droplet name="TBSProcessOrder">
	 		...
	 		<dsp:param name="minimalOrderDetails" value="true"/>
			...
			<dsp:droplet name="Range">
				...
				<dsp:oparam name="output">
					...
					<div class="small-1 columns no-padding-left plusMinus hide-for-print">
						...
						<div class="small-12 medium-2 columns no-padding-right left">
						...
						<div class="small-12 medium-1 columns no-padding-right left">
