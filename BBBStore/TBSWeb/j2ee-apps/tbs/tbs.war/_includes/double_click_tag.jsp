	...
	<c:choose>
		<c:when test="${ord eq null}">
			<script type="text/javascript">
				...
				document.write('<iframe type="some_value_to_prevent_js_error_on_ie7" src="${doubleClickUrl}/activityi;${requestParam};ord=' + a + '?" title="${lbl_doubleclick_iframe_title}" width="1" height="1" frameborder="0" style="display:none"></iframe>');
			</script>
			<noscript>
				<iframe type="some_value_to_prevent_js_error_on_ie7" src="${doubleClickUrl}/activityi;${requestParam};ord=1?"  width="1" height="1" title="${lbl_doubleclick_iframe_title}" frameborder="0" style="display:none"></iframe>
			</noscript>
		</c:when>
		<c:otherwise>
				<iframe type="some_value_to_prevent_js_error_on_ie7" src="${doubleClickUrl}/activityi;${requestParam}" width="1" height="1" title="${lbl_doubleclick_iframe_title}" frameborder="0" style="display:none"></iframe>
		</c:otherwise>
	</c:choose>
