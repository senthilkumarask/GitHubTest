...
<c:set var="plpViewParam" value="&view=${plpView}"/>
	...
	<div class="small-12 columns">
									...
									<li class="nextViewPage">
										<c:choose>
											<c:when test="${currentPage > 1}">
												...
												<a class="button left secondary" href="${urlNew}${filterAppliedWithPrefix}${seoPageNoPrev}?<dsp:valueof param="browseSearchVO.pagingLinks.previousPage"/>${subCategoryPageParam}${plpViewParam}"><span>&nbsp;</span></a>
											</c:when>
											<c:otherwise>
												<a class="button left secondary disabled" href="${urlNew}${filterAppliedWithPrefix}${seoPageNoPrev}?<dsp:valueof param="browseSearchVO.pagingLinks.previousPage"/>${subCategoryPageParam}${plpViewParam}"><span>&nbsp;</span></a>
		...
		<%-- 										<li class="selected"><a href="#">${pageFilterSize}</a></li> --%>
						...
						<div class="small-12 medium-3 right columns show-for-medium-down no-padding">
