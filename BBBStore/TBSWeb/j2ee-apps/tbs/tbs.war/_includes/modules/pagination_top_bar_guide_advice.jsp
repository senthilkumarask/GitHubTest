...
<div class="small-12 columns large-no-padding-right">
	...
	<form id="frmPagination" method="post" action="#">
		...
		<div class="row">
			<div class="small-6 large-4 columns no-padding">
			...
			<div class="refinements">
			 <div class=" pagination grid-page-control hide-for-medium-down">
							...
							<c:when test="${item eq 'View All'}">
								<c:choose>
									<c:when test="${isViewAll eq true}">
										<li class="selected"><a href="${url}${filterAppliedWithPrefix}/1-${count}?<dsp:valueof param="browseSearchVO.pagingLinks.firstPage"/>${searchViewParam}" selected="selected">${item}</a></li>
									</c:when>
									<c:otherwise>
   ...
   <div class="grid-sort sort hide-for-medium-down">
                            ...
                            <c:if test="${currentSiteId ne TBS_BedBathCanadaSite}">
                                ...
                                <c:choose>
                                    <c:when test="${ (pagSortOpt == 'Brand-0')}">
                                        <li class="active"><a href="${url}${filterAppliedWithPrefix}?pagSortOpt=Brand-0${searchQueryParams}${partialFlagUrl}" selected><bbbl:label key="lbl_sortby_options_9" language="${pageContext.request.locale.language}" /></a></li>
                                    </c:when>
                                    <c:otherwise>
			...
			<div class="small-6 right columns show-for-medium-down no-padding">
