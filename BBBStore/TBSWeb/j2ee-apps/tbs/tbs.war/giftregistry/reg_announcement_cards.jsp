<dsp:page>
	...
	<c:if test="${not empty appid && appid eq 'TBS_BedBathUS'}">
		...
		<jsp:body>
			<div id="content" class="container_12 clearfix" role="main">
				...
				<bbbl:label key="lbl_reg_feature_home" language="${pageContext.request.locale.language}" />
					...
					<a href="${contextPath}" title="${lbl_reg_feature_home}"><bbbl:label key="lbl_reg_feature_home" language ="${pageContext.request.locale.language}"/></a> <span class="rightCarrot">
						&gt;
					</span> 
					<c:choose>
						...
						<c:otherwise>
						    ...
						    <c:choose>
						    <c:when test="${siteId eq 'TBS_BedBathUS' || siteId eq 'TBS_BedBathCanada'}">
					 ...
					 <span class="rightCarrot">
						&gt;
					</span> <span class="bold">Registry Announcement Cards</span>
				</div>
					...
					<dsp:droplet name="GiftRegistryAnnouncementCardDroplet">
					    ...
					    <dsp:oparam name="output">
			                ...
			                <dsp:form id="announcementCardsMain" action="${contextPath}/giftregistry/registry_confirmation.jsp">
		                        ...
		                        <dsp:input bean="GiftRegistryFormHandler.fromPage"  type="hidden" value="regAnnouncementCards" />                     
