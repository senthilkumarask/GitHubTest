            ...
            <c:when test="${event == 'BA1'}">
                <div id="step1Preview" class="row">
                        ...
                        <div class="regsitryItem">
							<h3>
								...
								<c:when test="${empty regVO}">
									<span class="regsitryItemTitle"><bbbl:label key="lbl_regcreate_tell_us_abt_event" language="${pageContext.request.locale.language}"/> <a href="#edit1" id="step1EditLink" class="editRegistryLink" title='<bbbl:label key="lbl_regcreate_edit" language="${pageContext.request.locale.language}"/>'><bbbl:label key="lbl_regcreate_edit" language="${pageContext.request.locale.language}"/></a></span>
                    ...
                    <div id="step1Information" class="grid_12 alpha omega stepInformation form clearfix">
                        ...
                        <%--BBBSL-10947 | Commented as we do not have to show baby field --%>
<%--                         <div class="grid_2 pushDown">
                            <div class="entry">
                ...
                <div id="step1Form" class="row">
                    <div id="step1FormPost" class="small-12 large-12 columns no-padding">
                        <div class="small-12 large-8 alpha"> 
                                        ...
                                        <div class="grid_2 alpha">
                                            <dsp:droplet name="BBBConfigKeysDroplet">
                                                ...
                                                <dsp:oparam name="output">
                                                    ...
                                                    <dsp:select tabindex="3" bean="GiftRegistryFormHandler.registryVO.event.babyGender"  id="selRegistryGender" iclass="uniform"> 
                										<dsp:tagAttribute name="aria-required" value="false"/>
...
<%--                                 <div class="inputField clearfix" id="babyName">
                                ...
                                <div class="inputField clearfix" id="babyNurseryTheme">
                                    <div class="label">
                                        <label  id="lbltxtRegistryBabyNurseryTheme" for="txtRegistryTheme" >
                                           <bbbl:label key="lbl_event_theme" language="${pageContext.request.locale.language}"/>
                                        </label>
                                    </div>
                                    <div class="textarea">
                                        <dsp:input tabindex="5" 
                                                bean="GiftRegistryFormHandler.registryVO.event.babyNurseryTheme"
                                                type="text" id="txtRegistryTheme" value="${regVO.event.babyNurseryTheme}" iclass="cannotStartWithSpecialChars cannotStartWithNumber" maxlength="30" >
                                                <dsp:tagAttribute name="aria-required" value="true"/>
                                                <dsp:tagAttribute name="aria-labelledby" value="lbltxtRegistryBabyNurseryTheme errortxtRegistryBabyNurseryTheme"/>
                                            </dsp:input>
                                    </div>
                            ...
                            <c:if test="${empty regVO}">
                                <div class="small-12 medium-4 large-4 columns input submit small pushDown no-padding">
                                        <input tabindex="6" class="small button service expand" id="step1FormPostButton" type="button" name="" value="<bbbl:label key="lbl_event_next" language="${pageContext.request.locale.language}"/>" role="button" aria-pressed="false" />
                                </div>
                        	</c:if>
                        </div>
            ...
            <c:when test="${event == 'COL'}">
                ...
                <div id="step1Form" class="row">
                    <div id="step1FormPost" class="small-12 columns form post padTop_10">
                        <div class="small-12 large-8 columns alpha clearfix">
                            <legend class="formTitle offScreen"><bbbl:label key="lbl_event_info_title" language ="${pageContext.request.locale.language}"/></legend>
                            <div class="registryForm">
                                    ...
                                    <div class="text">
                                        <div class="grid_2 alpha">
                                            <dsp:input tabindex="2" 
                                                ...
                                                type="text" id="txtRegistryCollegeName" value="${regVO.event.college}" iclass="required cannotStartWithSpecialChars cannotStartWithNumber" maxlength="30"  priority="1" >
                                                <dsp:tagAttribute name="aria-required" value="true"/>
                             ...
                             <c:if test="${empty regVO}">
								<div class="small-12 medium-4 large-4 columns input submit small pushDown no-padding">
                                        <input tabindex="3" class="small button service expand" id="step1FormPostButton" type="button" name="" value="<bbbl:label key="lbl_event_next" language="${pageContext.request.locale.language}"/>" role="button" aria-pressed="false" aria-labelledby="step1FormPostButton" />
	                        	</div>
                            </c:if>
                        </div>
                        <div class="small-12 large-4 columns omega marLeft_20">
            ...
            <c:when test="${event == 'BRD' || event == 'COM'}">
                <div id="step1Preview" class="row">
                    ...
                    <div id="step1Information" class="alpha omega stepInformation form clearfix">
                        <div class="large-4 columns alpha pushDown">
                            <div class="entry">
                                <div class="field"><bbbl:label key="lbl_event_eventdate" language ="${pageContext.request.locale.language}"/></div>
                                <div class="value" id="valRegistryExpectedDate"></div>
                            </div>
                        </div>
                        <div class="large-4 columns pushDown">
                            <div class="entry">
                    ...
                    <div id="step1FormPost" class="small-12 large-12 columns no-padding">
                        <div class="small-12 large-8 columns alpha clearfix">
                            ...
                            <div class="registryForm">
                             ...
                             <c:if test="${empty regVO}">
								<div class="small-12 medium-4 large-4 columns input submit small pushDown no-padding">
                                        <input tabindex="4" class="small button service expand" id="step1FormPostButton" type="button" name="" value="<bbbl:label key="lbl_event_next" language="${pageContext.request.locale.language}"/>" role="button" aria-pressed="false" aria-labelledby="step1FormPostButton" />
	                        	</div>
	                        </c:if>
                        </div>
                        <div class="small-12 large-4 columns omega marLeft_20">
            ...
            <c:when test="${event == 'BIR'|| event== 'BR1' || event == 'ANN'}">
                <div id="step1Preview" class="row">
                        <div class="regsitryItem small-12 columns no-padding">
							<h3>
								<span class="regsitryItemNumber">1</span>
								<c:choose>
								<c:when test="${empty regVO}">
                    ...
                    <div id="step1Information" class="alpha omega stepInformation form clearfix">
                        ...
                        <div class="grid_2 <c:if test="${siteId != 'TBS_BuyBuyBaby'}"> alpha </c:if> pushDown">
                            <div class="entry">
                    ...
                    <div id="step1FormPost" class="small-12 large-12 columns no-padding">
                        <div class="small-12 large-8 columns alpha clearfix">
                            ...
                            <div class="registryForm">
                                ...
                                <c:if test="${siteId ne 'TBS_BuyBuyBaby'}">
                                    <div class="inputField clearfix" id="guestCount" >
                                        <div class="label">
                                            <label id="lbltxtRegistryNumberOfGuests" for="txtRegistryNumberOfGuests">
                                                 <bbbl:label key="lbl_event_num_of_guests" language ="${pageContext.request.locale.language}"/>
