   ...
   <dsp:page>
    <bbb:pageContainer section="${section}" pageWrapper="${pageWrapper}" titleString="${titleString}" pageVariation="${pageVariation}">
      ...
      <jsp:body>
		  ...
		  <div id="heroContent" class="${loggedOut} row">
         ...
         <dsp:droplet name="LandingTemplateDroplet">
	      	...
	      	<dsp:oparam name="output"> 
					...
					<c:choose>
			      	   <c:when test="${regbaby eq true }">
				      	   <div class="addRegistryContainer row">
				...
				<c:if test="${not empty bridalTool}">
				 <div class="cb clearfix marTop_20 row babyRegistryFeatures">
				...
				<dsp:droplet name="/atg/dynamo/droplet/IsNull"> 
					...
					<c:if test="${FBOn}">
					<div id="fbActivity" class="small-6 medium-3 columns fbActivity">
						<c:set var="fbFeedSite"><bbbc:config key="FBLikeBabySiteUrl" configName="ThirdPartyURLs" /></c:set>
			...
			<dsp:droplet name="/atg/dynamo/droplet/ForEach">
	          <dsp:param param="LandingTemplateVO.promoTierLayout1" name="array"/>
	           <dsp:oparam name="output">
	             <div class="row clearfix spacing spacingBottom">
	                <div class="small-12 medium-6 columns">
