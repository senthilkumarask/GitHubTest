...
<dsp:droplet name="GiftRegistryAnnouncementCardDroplet">
    ...
    <dsp:oparam name="output">
		<div title="Registry Announcement Cards" class="container_6">
			...
			<dsp:form id="announcementCards" action="${contextPath}/giftregistry/registry_confirmation.jsp">
			...
			<p class="marTop_10">
				...
				<dsp:input name="registryAnnouncement" type="radio" 
                    ...
                    <dsp:tagAttribute name="aria-labelledby" value="lblreg25 errorregistryAnnouncement"/>
                </dsp:input>
				...
				<dsp:input name="registryAnnouncement" type="radio"			
                    ...
                    <dsp:tagAttribute name="aria-labelledby" value="lblreg50 errorregistryAnnouncement"/>
                </dsp:input>
				...
				<dsp:input name="registryAnnouncement" type="radio" 
                    ...
                    <dsp:tagAttribute name="aria-checked" value="false"/>
                    <dsp:tagAttribute name="aria-labelledby" value="lblreg75 errorregistryAnnouncement"/>
                </dsp:input>
				...
				<dsp:input name="registryAnnouncement" type="radio" 
                    ...
                    <dsp:tagAttribute name="aria-checked" value="false"/>
                    <dsp:tagAttribute name="aria-labelledby" value="lblreg100 errorregistryAnnouncement"/>
                </dsp:input>
				...
				<label id="errorregistryAnnouncement" for="registryAnnouncement" generated="true" class="error"></label>
			...
			<dsp:input bean="GiftRegistryFormHandler.fromPage" type="hidden" 
				...
				<dsp:input type="submit" value="Submit" 
                    ...
                    <div class="button button_active">
                       <input type="button" id="registryAnnouncementCancel" value="cancel" class="close-any-dialog" role="button" aria-pressed="false" aria-labelledby="registryAnnouncementCancel" />
                    </div>
                </div>
            </div>
		</div>
    ...
    <dsp:oparam name="error">
	    <div title="Registry Announcement Cards" class="container_6">
			...
			<div class="marTop_20 buttonpane clearfix">
			 	<div class="button button_active">
                       <input type="button" id="registryAnnouncementCancel" value="ok" class="close-any-dialog" />
              	</div>
            </div>
