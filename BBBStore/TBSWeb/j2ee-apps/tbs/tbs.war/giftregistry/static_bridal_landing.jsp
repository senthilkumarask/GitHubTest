...
<ul class=" row container_12">
			<li class="small-2 columns noCarousel"><a onclick="s_objectID=&quot;http://www.bedbathandbeyond.com/store/registry/RegistryChecklist_2&quot;;return this.s_oc?this.s_oc(e):true" title="Registry Checklist" href="/store/registry/RegistryChecklist">
				<img src="//s7d9.scene7.com/is/image/BedBathandBeyond/images/registry/icon_20121220_bridalchecklist.jpg" alt="Registry Checklist">
					<p class="grid_1 prodIcons">Registry <br> Checklist</p>	</a>	</li>	
			<li class="small-2 columns noCarousel"><a onclick="s_objectID=&quot;http://www.bedbathandbeyond.com/store/registry/GuidesAndAdviceLandingPage_2&quot;;return this.s_oc?this.s_oc(e):true" title="Guides &amp; Advice" href="/store/registry/GuidesAndAdviceLandingPage">
				<img src="//s7d9.scene7.com/is/image/BedBathandBeyond/images/registry/icon_20121220_bridalguides.jpg" alt="Guides &amp; Advice">
					<p class="grid_1 prodIcons">Guides <br>&amp; Advice</p>	</a>	</li>	
			<li class="small-2 columns noCarousel"><a onclick="s_objectID=&quot;http://www.bedbathandbeyond.com/store/bbregistry/BridalBook_2&quot;;return this.s_oc?this.s_oc(e):true" title="Wedding Registry Book" href="/store/bbregistry/BridalBook">
				<img src="//s7d9.scene7.com/is/image/BedBathandBeyond/images/registry/icon_20121220_bridalbook.jpg" alt="Wedding Registry Book">
					<p class="grid_1 prodIcons">Wedding<br>Registry Book</p>	</a>	</li>	
			<li class="small-2 columns noCarousel"><a onclick="s_objectID=&quot;http://www.bedbathandbeyond.com/store/registry/PersonalizedInvitations_2&quot;;return this.s_oc?this.s_oc(e):true" title="Personalized Invitations" href="/store/registry/PersonalizedInvitations">
				<img src="//s7d9.scene7.com/is/image/BedBathandBeyond/personalizedinvitations?$other$" alt="Personalized Invitations">
					<p class="grid_1 prodIcons">Personalized <br>Invitations</p>	</a>	</li>	
			<li class="small-2 columns noCarousel"><a onclick="s_objectID=&quot;http://www.bedbathandbeyond.com/store/registry/RegistryAnnouncementCards_1&quot;;return this.s_oc?this.s_oc(e):true" title="Announcement Cards" href="/store/registry/RegistryAnnouncementCards">
				<img src="//s7d9.scene7.com/is/image/BedBathandBeyond/images/registry/icon_20121220_bridalannouncements.jpg" alt="Announcement Cards">
					<p class="grid_1 prodIcons">Announcement <br>Cards</p>	</a>	</li>	
		</ul>
			...
			<dsp:getvalueof param="LandingTemplateVO.bridalTool" var="bridalTool"/>
							...
							<dsp:droplet name="/atg/dynamo/droplet/ForEach">
			                 ...
			                 <c:set var="title"><dsp:valueof param="element.linkLabel" valueishtml="true"/></c:set>
							   	...
							   	<c:when test="${title eq 'Bridal Toolkit'}">
									<li class="noCarousel"><a title="<dsp:valueof param="element.imageAltText"/>" href="${contextPath}/giftregistry/registry_features.jsp?pageName=BridalToolkit">
									    <c:choose>
	         ...
	         <div id="content" class="container_12 clearfix bridalLanding" role="main">	
				<div class="grid_12 clearfix flashRow">
					...
					<div id="fbActivity" class="grid_3 omega fbActivity">
					    <c:set var="fbFeedSite"><bbbc:config key="FBLikeBridalSiteUrl" configName="ThirdPartyURLs" /></c:set>
					    <div class="fb-like-box" data-href="${fbFeedSite}" data-width="229" data-height="302" data-show-faces="false" data-border-color="#cccccc" data-stream="true" data-header="false"></div>
					</div>
