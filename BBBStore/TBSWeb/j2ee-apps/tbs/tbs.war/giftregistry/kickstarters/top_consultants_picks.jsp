		...
		<div id="content" class="container_12 clearfix topConsultantsPicks" role="main">		
        	...
        	<div class="row topPicksHeader">
              ...
              <%-- End code to set previous and next consultant urls--%>       	
				...
				<div class="small-3 columns topConsultantsPicksNav marTop_20" >
			...
			<dsp:oparam name="output">
           	...
           	<div class="row topConsultantDetails">
                <div class="small-12 medium-3 columns">
                	<img class="topConsultantsPicksImage" src="${imagePath}" height="209" width="209"/>
                </div>	        	
	        	
	        	<div class="small-12 medium-6 columns topConsultantInfo">
	        		<h3 class="consultantName">${heading1}</h3>
	        		<h5>${heading2}</h5>
	        		<p><dsp:valueof param="kickStarterVO.description" valueishtml="true"/></p>
           	...
           	<div id="shopCollection" class="collectionItemsBox row collectionGridView">		      
