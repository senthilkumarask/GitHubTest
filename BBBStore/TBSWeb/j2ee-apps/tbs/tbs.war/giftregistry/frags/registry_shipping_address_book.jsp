...
<div class="registryForm">
    <fieldset class="radioGroup">
        ...
        <div class="row radioItem input clearfix">
											...
											<c:when test="${not empty shipTo_POBoxOn &&  shipTo_POBoxOn}">
												<div class="small-1 columns radio">
													<dsp:input tabindex="${tabIndex}"
														id="radRegistryCurrentShippingAddress01" type="radio"
														name="radRegistryCurrentShippingAddressName"
														value="oldShippingAddressFromWS"
                                                         ...
                                                         <c:when test="${not empty shipTo_POBoxOn &&  shipTo_POBoxOn}">
                                                          <div class="small-1 columns radio">
                                                                <dsp:input tabindex="${tabIndex}" id="radRegistryCurrentShippingAddress${counter}" type="radio"
                                                                    name="radRegistryCurrentShippingAddressName" 
                                                                    value="${addressId}" bean="GiftRegistryFormHandler.shippingAddress">
                                                                    <dsp:tagAttribute name="aria-checked" value="false"/>
                                                                    <dsp:tagAttribute name="aria-labelledby" value="lblradRegistryCurrentShippingAddress${counter}"/>
                                                                </dsp:input>
                                                            </div>
                                                            </c:when>
                                                            <c:otherwise><div class="small-1 columns radio">
                                                                <dsp:input tabindex="${tabIndex}" id="radRegistryCurrentShippingAddress${counter}" type="radio"
                                                                    name="radRegistryCurrentShippingAddressName" 
        ...
        <div class="row radioItem input last clearfix">
            <div class="small-1 columns radio">
                <c:choose>
            ...
            <div class="subForm small-12 columns validateFormWithQAS">
