<fieldset class="radioGroup clearfix grid_4 alpha omega" id="future-address">
    ...
    <div class="radioItem input clearfix grid_4 alpha omega">
        ...
        <div class="small-11 columns label no-padding-left">
        ...
        <dsp:oparam name="output">
            ...
            <c:if test="${!(isWSAddressInAddressBook) && !(empty regVO.shipping.futureshippingAddress.addressLine1)}">
                <div class="radioItem input clearfix grid_4 alpha omega">
                            ...
                            <c:choose>
                                <c:when test="${isValid}">
									<div class="radio">
										<c:choose>
											<c:when test="${not empty shipTo_POBoxOn &&  shipTo_POBoxOn}">
												<dsp:input tabindex="${tabIndex}"
													value="oldFutShippingAddressFromWS"
													...
													<dsp:tagAttribute name="aria-labelledby"
														value="lblradRegistryFutureShippingAddress01" />
												</dsp:input>
                    ...
                    <div class="label" small-11 columns no-padding-left>
                                            ...
                                            <dsp:oparam name="output">
                                                ...
                                                <c:choose>
                                                    <c:when test="${isValid}">
														...
														<c:choose>
															<c:when
																test="${not empty shipTo_POBoxOn &&  shipTo_POBoxOn}">
																<div class="radio small-1 columns">
																	<dsp:input tabindex="${tabIndex}" value="${addressId}"
																		id="radRegistryFutureShippingAddress${counter}"
																		type="radio"
																		name="radRegistryFutureShippingAddressName"
																		bean="GiftRegistryFormHandler.futureShippingAddress">
																		<dsp:tagAttribute name="aria-checked" value="false" />
																		<dsp:tagAttribute name="aria-labelledby"
																			value="lblradRegistryFutureShippingAddress${counter}" />
																	</dsp:input>
																</div>
															</c:when>
															<c:otherwise>
    ...
    <div class="radioItem input clearfix grid_4 alpha omega last">
        ...
        <div class="small-12 columns subForm validateFormWithQAS">
           ...
           <div class="inputSelect pushDown">
                <label id="lblselRegistryFutureShippingState" for="selRegistryFutureShippingState">
                    <c:choose>
                        <c:when test="${siteId eq TBS_BedBathCanadaSiteCode}">
                ...
                <dsp:tagAttribute name="aria-labelledby" value="lblselRegistryFutureShippingState errorselRegistryFutureShippingState"/>
                    <dsp:droplet name="StateDroplet">
                        ...
                        <dsp:oparam name="output">
                            <c:choose>
                                <c:when test="${siteId == TBS_BedBathCanadaSiteCode}">
            ...
            <div class="inputField clearfix" id="shippingFutureAddrZip">
                ...
                <c:choose>
                    <c:when test="${currentSiteId eq TBS_BedBathCanadaSiteCode}">
