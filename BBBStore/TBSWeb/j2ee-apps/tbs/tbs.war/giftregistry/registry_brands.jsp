...
<dsp:importbean bean="/com/bbb/commerce/browse/droplet/BrandDetailDroplet"/>
	<div class="carousel clearfix row padBottom_10"> 
		 <div class="carouselBody grid_9"> 
			<div class="grid_1 carouselArrow omega carouselArrowPrevious clearfix"> &nbsp; <a href="#" title="Previous" class="carouselScrollPrevious" style="display: block;">Previous</a> </div>
            ...
            <div class="grid_1 carouselArrow alpha carouselArrowNext clearfix"> &nbsp; <a href="#" title="Next" class="carouselScrollNext" style="display: block;">Next</a> </div>         
		</div>
