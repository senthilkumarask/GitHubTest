...
<dsp:form action="order_review.jsp" method="post">
...
<%-- @version $Id: //product/DCS/version/10.0.3/release/DCSSampleCatalog/j2ee-apps/sampleCatalog/web-app/order_confirm_b2c.jsp#2 $$Change: 651448 $--%>
