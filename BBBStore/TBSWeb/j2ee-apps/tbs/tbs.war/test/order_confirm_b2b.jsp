...
<dsp:input bean="CommitOrderFormHandler.commitOrderSuccessURL" type="hidden" value="order_commit.jsp"/>
<dsp:input bean="CommitOrderFormHandler.SessionExpirationURL" type="hidden" value="session_expired.jsp"/>
...
<dsp:droplet name="ForEach">
  ...
  <dsp:oparam name="output">
    ...
    Amount: <dsp:valueof param="currency"/>
  </dsp:oparam>
</dsp:droplet>

<P>

<dsp:input bean="CommitOrderFormHandler.commitOrder" type="submit" value="Purchase"/>
...
<%-- @version $Id: //product/DCS/version/10.0.3/release/DCSSampleCatalog/j2ee-apps/sampleCatalog/web-app/order_confirm_b2b.jsp#2 $$Change: 651448 $--%>
