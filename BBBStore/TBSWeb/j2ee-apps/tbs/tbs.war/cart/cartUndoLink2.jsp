			...
			<dsp:droplet name="ForEach">
				...
				<dsp:getvalueof var="ltlShipMethod" param="wishlist.ltlShipMethod"/>
					...
					<c:if test="${(not empty itemMoveFromCartID and (itemMoveFromCartID eq wishlist.wishListItemId)) and moveOperation}">
							<div class="cartRow changeStoreItemWrap clearfix savedItem itemJustMovedToSaveUndoLink">
									<div class="prodItemWrapper clearfix">
										...
										<p class="small-2 columns textRight">
											...
											<a href="#cartItemsTotalAndCouponsWrapper" title="View your saved items" class="lnkAction viewSavedItems">${lbl_save_top_link_view_saved}</a>
										</p>
									</div>
							</div>
					</c:if>
