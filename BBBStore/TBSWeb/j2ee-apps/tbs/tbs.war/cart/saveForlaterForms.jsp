<dsp:page>
	...
	<dsp:form formid="frmSaveItemRemove" id="frmSaveItemRemove" iclass="frmAjaxSubmit clearfix frmSaveItemRemove" method="post" action="/tbs/wishlist/_ajax/itemJustMovedToSave_ajax_handler.jsp">
		<dsp:input bean="GiftlistFormHandler.fromPage" type="hidden" value="itemJustMovedToSave" />
		<%-- Client DOM XSRF | Part -2
		<dsp:input bean="GiftlistFormHandler.removeItemsFromGiftlistSuccessURL" type="hidden" value="/tbs/wishlist/_ajax/itemJustMovedToSave_ajax_handler.jsp" />
		<dsp:input bean="GiftlistFormHandler.removeItemsFromGiftlistErrorURL" type="hidden" value="/tbs/wishlist/_ajax/itemJustMovedToSave_ajax_handler.jsp" /> --%>
	...
	<dsp:form formid="frmSaveForLater" id="frmSaveForLater" iclass="frmAjaxSubmit clearfix frmSaveForLater" method="post" action="/tbs/wishlist/_ajax/itemJustMovedToSave_ajax_handler.jsp">
		...
		<dsp:input id="fromWishlist" bean="CartModifierFormHandler.fromWishlist" type="hidden" iclass="frmAjaxSubmitData hidden" value="true" />
		<dsp:input id="wishListId" bean="CartModifierFormHandler.wishListId" type="hidden">
			<dsp:tagAttribute name="data-ajax-fieldName" value="cartWishListItemId" />
		</dsp:input>
		<dsp:input id="wishlistItemId" bean="CartModifierFormHandler.wishlistItemId" type="hidden" iclass="frmAjaxSubmitData hidden">
			<dsp:tagAttribute name="data-ajax-fieldName" value="cartWishListItemId" />
		</dsp:input>
		<dsp:input id="registryId" bean="CartModifierFormHandler.items[0].value.registryId" type="hidden" iclass="frmAjaxSubmitData hidden">
	...
	<dsp:input bean="CartModifierFormHandler.items[0].value.whiteGloveAssembly" type="hidden" iclass="frmAjaxSubmitData hidden">
		...
		<dsp:input bean="CartModifierFormHandler.fromPage" type="hidden"
												value="saveForLaterForms" />
		<%-- <dsp:input bean="CartModifierFormHandler.addItemToOrderSuccessURL" iclass="frmAjaxSubmitData hidden" type="hidden" value="/tbs/wishlist/_ajax/itemJustMovedToSave_ajax_handler.jsp" />
		<dsp:input bean="CartModifierFormHandler.addItemToOrderErrorURL" iclass="frmAjaxSubmitData hidden" type="hidden" value="/tbs/wishlist/_ajax/itemJustMovedToSave_ajax_handler.jsp" /> --%>
		<dsp:input bean="CartModifierFormHandler.addItemToOrder" type="submit" iclass="frmAjaxSubmitData hidden" value="MOVE TO CART" />
	</dsp:form>
	<dsp:form formid="frmRegSaveForLater" id="frmRegSaveForLater" iclass="frmAjaxSubmit clearfix frmRegSaveForLater" method="post" action="/tbs/wishlist/_ajax/itemJustMovedToSave_ajax_handler.jsp">
		<dsp:input id="catalogRefId" bean="GiftRegistryFormHandler.skuId" iclass="frmAjaxSubmitData hidden" type="hidden">
			<dsp:tagAttribute name="data-ajax-fieldName" value="skuID" />
		</dsp:input>
		<dsp:input id="productId" bean="GiftRegistryFormHandler.productId" iclass="frmAjaxSubmitData hidden" type="hidden">
			<dsp:tagAttribute name="data-ajax-fieldName" value="prodID" />
		</dsp:input>
		<dsp:input id="quantity" bean="GiftRegistryFormHandler.quantity" iclass="frmAjaxSubmitData hidden" type="hidden">
		...
		<dsp:input bean="GiftRegistryFormHandler.moveToRegistryResponseURL" value="/tbs/wishlist/_ajax/itemJustMovedToSave_ajax_handler.jsp" iclass="frmAjaxSubmitData hidden" type="hidden" />
	...
	<dsp:form formid="frmSaveForLaterItemEdit" id="frmSaveForLaterItemEdit" iclass="clearfix frmSaveForLaterItemEdit" method="post" action="/tbs/wishlist/wish_list.jsp">
    ...
    <%-- Client DOM XSRF
    <dsp:input bean="GiftlistFormHandler.personalizedEditItemFormsErrorURL" iclass="" type="hidden" value="/tbs/wishlist/wish_list.jsp" />
    <dsp:input bean="GiftlistFormHandler.personalizedEditItemFormsSuccessURL" iclass="" type="hidden" value="/tbs/wishlist/wish_list.jsp" /> --%>
