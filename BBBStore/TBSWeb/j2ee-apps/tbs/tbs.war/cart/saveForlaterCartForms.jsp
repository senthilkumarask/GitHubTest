<dsp:page>
	...
	<dsp:form formid="frmSaveItemRemove" id="frmSaveItemRemove" iclass="frmAjaxSubmit clearfix frmSaveItemRemove" method="post" action="ajax_handler_cart.jsp">
		...
		<dsp:input bean="GiftlistFormHandler.removeItemsFromGiftlistSuccessURL" type="hidden" value="/tbs/cart/ajax_handler_cart.jsp" />
		<dsp:input bean="GiftlistFormHandler.removeItemsFromGiftlistErrorURL" type="hidden" value="/tbs/cart/ajax_handler_cart.jsp" /> --%>
	...
	<dsp:form formid="frmRegSaveForLater" id="frmRegSaveForLater" iclass="frmAjaxSubmit clearfix frmRegSaveForLater" method="post" action="ajax_handler_cart.jsp">
		...
		<dsp:input bean="GiftRegistryFormHandler.moveToRegistryResponseURL" value="/tbs/cart/ajax_handler_cart.jsp" iclass="frmAjaxSubmitData hidden" type="hidden" />
    ...
    <%-- Client DOM XSRF
    <dsp:input bean="GiftlistFormHandler.personalizedEditItemFormsErrorURL" iclass="" type="hidden" value="/tbs/cart/cart.jsp" />
    <dsp:input bean="GiftlistFormHandler.personalizedEditItemFormsSuccessURL" iclass="" type="hidden" value="/tbs/cart/cart.jsp" /> --%>
</dsp:form>
</dsp:page>
