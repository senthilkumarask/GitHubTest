    ...
    <div id="content" role="main">
        <div  class="container_12 clearfix">
            ...
            <div class="grid_7 clearfix">
           	<form name="frmFindCollege" method="post" id="frmFindYourCollege" action="findyourcollege.jsp">
				<fieldset>
             ...
             <c:set var="findCollegePromo">
                 <bbbl:textArea key="txt_findyourcollege_image_grid" language="${pageContext.request.locale.language}"/>
             </c:set>
             <c:set var="findCollegePromoNew" value="${fn:replace(findCollegePromo, '/store','/tbs')}" />
             ${findCollegePromoNew}
              <dsp:droplet name="IsEmpty">
