				...
				<div class="input grid_3 alpha suffix_3">
					<div class="label">
						<label id="lblemailaddress" for="emailaddress"><bbbl:label
										...
										language="${pageContext.request.locale.language}" /><span class="required hidden"><bbbl:label key="lbl_mandatory" language ="${pageContext.request.locale.language}"/></span></label>
					</div>
					<div class="text">
						<dsp:input bean="EasyReturnsFormHandler.emailaddress" name="emailaddress" type="text" id="emailaddress" maxlength="150">
	                        <dsp:tagAttribute name="aria-required" value="true"/>
					...
					<div class="grid_6 alpha">
						...
						<div class="radio">
							<dsp:input id="displayEmailReturn" name="rslevel" type="radio" bean="EasyReturnsFormHandler.rslevel" value="4">
                                    <dsp:tagAttribute name="aria-checked" value="false"/>
                                    <dsp:tagAttribute name="aria-labelledby" value="lbldisplayEmailReturn"/>
                            </dsp:input>
						</div>						
							<label id="lbldisplayEmailReturn" for="displayEmailReturn"  class="marRight_10"><bbbl:label
									key="lbl_easy_return_form_option3"
									language="${pageContext.request.locale.language}" /></label>					
					</div>
