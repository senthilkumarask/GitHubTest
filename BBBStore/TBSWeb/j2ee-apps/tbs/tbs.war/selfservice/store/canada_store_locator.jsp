				    	     		...
				    	     		<c:choose>
				     	     			<c:when test="${currentState ne newState}">
				     	             	 <c:set var="currentState" value="${newState}"/>  
				     	                   ...
				     	                   <span>|</span><a class="first smoothScrollTo" data-smoothscroll-topoffset="48" title="${currentState}" href="#brandChar${currentStateCode}">${currentState}</a>     	  
				     	     			</c:when>
				     	     		</c:choose>
				    	...
				    	<dsp:oparam name="output">
				    	     ...
				    	     <dsp:getvalueof var="counter" param="counter"/>
 				    	     <c:choose>
				     	     	...
				     	     	<c:otherwise>
				     	     	      <div class="storeResult borderBottom large-12 columns no-padding">
				     	     	      <dsp:include page="canada_store_info.jsp">
					     	     	      <dsp:param name="storeDetails" param="element" />
					     	     	      <dsp:param name="counter" param="count" />
