    ...
    <c:when test="${siteId eq 'BuyBuyBaby'}">
    	<style type="text/css">
			...
			*/
			...
			<!--.bodyContent{ /*@editable*/ padding-top: 0px;}-->
			...
			*/
			...
			<!--.bodyContent p.highlightRed{ color: #FF0000; padding-top: 5px;}-->
			<!--.bodyContent p.quantity{ font-size: 13px; padding-top: 5px;}-->
