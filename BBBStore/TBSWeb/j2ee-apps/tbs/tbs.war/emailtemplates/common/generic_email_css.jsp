...
<c:choose>
    <c:when test="${siteId eq 'BedBathUS' || siteId eq 'BedBathCanada'}">
    	<c:choose>
    		<c:when test="${emailType eq 'EmailARegistry' || emailType eq 'EmailCoFoundRegistry' || emailType eq 'EmailCoNotFoundRegistry'}">
    			<style type="text/css">
					...
					*/
					...
					<!--#templateBody .small{ font-size: 12px; color: #999999;}-->
					...
					*/
					...
					<!--.bodyContent table.registryInfoTable p{ margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; font-family: arial; font-size: 12px; }-->
					
					
					<!--.bodyContent table.registryInfoTable { background-color: #56096F; color: #FFFFFF; }-->
					
					<!--.bodyContent table.registryInfoTable h3 { color: #FFF; margin: 0px; }-->
    		...
    		<c:when test="${emailType eq 'CoRegistrantEmail'}">
    			<style type="text/css">
					/* Client-specific Styles */
					<!--#outlook a{padding:0;}--> /* Force Outlook to provide a "view in browser" button. */
					<!--#outlook p.MsoNormal, #outlook .MsoNormal { line-height: 0px; font-family: arial;}-->
					...
					*/
					...
					<!--.bodyContent .listTypeTable td{ padding-top: 10px; padding-right: 5px; padding-bottom: 1px; padding-left: 5px; font-family: arial; font-size: 12px;}-->
    		...
    		<c:when test="${emailType eq 'EmailARegistry' || emailType eq 'EmailCoFoundRegistry' || emailType eq 'EmailCoNotFoundRegistry'}">
    			<style type="text/css">
					...
					*/
					...
					<!--.bodyContent table.registryInfoTable { background-color: #F75E9F; color: #FFFFFF; }-->
