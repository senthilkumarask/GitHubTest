...
<c:choose>
    <c:when test="${siteId eq 'BedBathUS' || siteId eq 'TBS_BedBathUS'}">
    	<style type="text/css">
			...
			*/
			...
			<!--.bodyContent table.orderConfirmationWrapper table.orderConfirmationDataTable td { border-top: 1px solid #E8E8E8;}-->
            ...
            <!--.bodyContent .spclSectionBoxGreen {margin-top:10px;}-->   
            <!--.bodyContent .spclSectionBoxGreen table { border-top: 5px solid #79BD1E; background-color:#F5FEE9; width:312px;}       
            <!--.bodyContent .spclSectionBoxGreen h2 { color: #79BD1E; font-size: 27px; font-weight: normal; text-transform: normal; line-height: 28px; margin: 0; }-->
            <!--.bodyContent .spclSectionBoxGreen .babyPromoText h2 { color: #F75E9F; font-size: 27px; font-weight: normal; text-transform: normal; line-height: 28px; margin: 0; }-->
            <!--.bodyContent .spclSectionBoxGreen .babyPromoText h2 strong { font-size: 27px; font-family: "FuturaStd",Arial, Helvetica, sans-serif; }-->
            <!--.bodyContent .spclSectionBoxGreen p { color: #666666; font-size: 12px; line-height:100%}-->
            <!--.bodyContent .spclSectionBoxGreen table td {padding:8px 10px;}-->          
            <!--.bodyContent .spclSection .smallText { color: #666666; font-size: 10px; line-height: normal }
            <!--.bodyContent .smallText { color: #666666; font-size: 10px }-->
    ...
    <c:when test="${siteId eq 'BedBathCanada' || siteId eq 'TBS_BedBathCanada'}">
    	<style type="text/css">
			/* Client-specific Styles */
			<!--#outlook a{padding:0;}--> /* Force Outlook to provide a "view in browser" button. */
			<!--#outlook p.MsoNormal, #outlook .MsoNormal { line-height: 0px; font-family: arial;}-->
    ...
    <c:otherwise>
    	<style type="text/css">
			...
			*/
			...
			<!--.bodyContent table.orderConfirmationWrapper table.orderConfirmationDataTable td { border-top: 1px solid #B2DBF3;}-->
            ...
            <!--.bodyContent .spclSectionBoxGreen {margin-top:10px;}-->   
            <!--.bodyContent .spclSectionBoxGreen table { border-top: 5px solid #79BD1E; background-color:#F5FEE9; width:312px;}       
            <!--.bodyContent .spclSectionBoxGreen h2 { color: #79BD1E; font-size: 27px; font-weight: normal; text-transform: lowercase; line-height: 28px; margin: 0; }-->
            <!--.bodyContent .spclSectionBoxGreen .babyPromoText h2 { color: #F75E9F; font-size: 27px; font-weight: normal; text-transform: normal; line-height: 28px; margin: 0; }-->
            <!--.bodyContent .spclSectionBoxGreen .babyPromoText h2 strong { font-size: 27px; font-family: "FuturaStd",Arial, Helvetica, sans-serif; }-->
            <!--.bodyContent .spclSectionBoxGreen p { color: #666666; font-size: 12px; line-height:100%}-->
            <!--.bodyContent .spclSectionBoxGreen table td {padding:8px 10px;}-->          
