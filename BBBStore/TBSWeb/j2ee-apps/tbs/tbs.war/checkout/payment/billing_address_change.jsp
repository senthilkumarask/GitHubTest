<dsp:page>
	...
	<dsp:form iclass="form clearfix" name="form" method="post" id="editAddressDialogForm" action="/tbs/checkout/payment/display_billing_address.jsp">
...
<!-- 		R2.1.1 International Credit Card ends -->
				...
				<div class="inputField clearfix">
					...
					<input type="text" name="${zipCodeClass}" iclass="width_1" id="txtAddressBookEditZip" aria-required="true" aria-labelledby="lblZipCode errortxtAddressBookEditZip"></input>
		...
		<!-- <dsp:input type="hidden" bean="BBBBillingAddressFormHandler.successURL" value="/tbs/checkout/payment/billing_payment.jsp"/>
		<dsp:input type="hidden" bean="BBBBillingAddressFormHandler.errorURL" value="/tbs/checkout/payment/billing_payment.jsp"/> -->
		<dsp:input type="hidden" bean="BBBBillingAddressFormHandler.systemErrorURL" value="/tbs/checkout/payment/billing_payment.jsp"/>
...
<div id="updateAddressWarningModal" title="Update Address" style="display:none;">
	<bbbl:label key="lbl_billingaddresschange_note1" language="${pageContext.request.locale.language}" />
</div>
<div id="removeAddressWarningModal" title="Remove Address" style="display:none;">
