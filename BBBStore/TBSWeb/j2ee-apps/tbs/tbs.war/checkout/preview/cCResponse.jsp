...
<dsp:page>
    ...
    <c:set var="url" scope="request">${pageContext.request.scheme}://${pageContext.request.serverName}/tbs/checkout/preview/cCAuthenticate.jsp</c:set>
    ...
    <c:choose>
        ...
        <c:otherwise>
            ...
            <c:set var="url" scope="request">${pageContext.request.scheme}://${pageContext.request.serverName}/tbs/checkout/payment/billing_payment.jsp</c:set>
        </c:otherwise>
    </c:choose>
