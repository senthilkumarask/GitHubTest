...
alter table BBB_SWITCH_A.BBB_HOMEPAGE_TEMPLATE add (
...
create table BBB_SWITCH_A.BBB_HOMEPAGE_FEAT_CATEGORY(
   ...
   CONSTRAINT BBB_HP_FEAT_CAT_FK1 FOREIGN KEY (homepage_template_id) REFERENCES BBB_SWITCH_A.BBB_HOMEPAGE_TEMPLATE (homepage_template_id), 
   CONSTRAINT BBB_HP_FEAT_CAT_FK2 FOREIGN KEY (cat_container_id) REFERENCES BBB_SWITCH_A.BBB_CATEGORY_CONTAINER (cat_container_id)
);

alter table BBB_SWITCH_A.BBB_PROMOBOX add promo_box_title VARCHAR2(150);
