...
<process author="admin" creation-time="1336653595732" enabled="true" last-modified-by="admin" modification-time="1354182057870">
  <segment migrate-from="1330425905678,1330588323324,1336559422474,1336653595743,1336670531408" migrate-subjects="true">
    ...
    <event id="1">
      ...
      <filter operator="eq">
        ...
        <constant>/staging/pimWorkflowProd.wdl</constant>
      </filter>
      <filter operator="eq">
        <event-property>
      ...
      <attributes>
        ...
        <attribute name="atg.workflow.displayName">
          <constant>PIM Production Project</constant>
        </attribute>
      </attributes>
    </event>
    <!--================================-->
      ...
      <branch id="4.1">
        ...
        <fork id="4.1.10">
          <branch id="4.1.10.1">
            ...
            <fork exclusive="true" id="4.1.10.1.5">
              <branch id="4.1.10.1.5.1">
                <!--================================-->
                <!--== Wait for deployment to complete on target Production  -->
                <!--================================-->
                <event id="4.1.10.1.5.1.1">
                  <event-name>atg.deployment.DeploymentStatus</event-name>
                  <filter operator="eq">
                    <event-property>
                      <property-name>targetId</property-name>
                ...
                <fork id="4.1.10.1.5.1.2">
                  <branch id="4.1.10.1.5.1.2.1">
                    <!--================================-->
                    <!--== Deployment completed event status is success on target Production  -->
                    <!--================================-->
                    <condition id="4.1.10.1.5.1.2.1.1">
                      <filter operator="deploymentCompleted">
                        <constant>1</constant>
                        <constant>Production</constant>
                      </filter>
                    ...
                    <!--================================-->
                    <action id="4.1.10.1.5.1.2.1.3">
                      <action-name>checkInProject</action-name>
                    </action>
                    <!--================================-->
                    <!--== Send task notification templates:/productionDeploymentSuccessTemplate.jsp to owner or permitted actors of task 1) author  -->
                    <!--================================-->
                    <action id="4.1.10.1.5.1.2.1.4">
                      <action-name>emailNotifyTaskActors</action-name>
                      <action-param name="scenarioPathInfo">
                        <constant>templates:/productionDeploymentSuccessTemplate.jsp</constant>
                      </action-param>
                      <action-param name="recipientSet">
                        <constant>ownerOrPermittedActors</constant>
                      </action-param>
                  ...
                  <branch id="4.1.10.1.5.1.2.2">
                    ...
                    <jump id="4.1.10.1.5.1.2.2.4" target="3"/>
                  </branch>
                </fork>
              </branch>
            </fork>
