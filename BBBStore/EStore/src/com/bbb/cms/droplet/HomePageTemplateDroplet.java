 ...
 *
 */
public class HomePageTemplateDroplet extends BBBDynamoServlet {
	...
	throws javax.servlet.ServletException, java.io.IOException {
		...
		try{
			...
			final HomePageTemplateVO homePageTemplateVO=getHomePageTemplateManager().getHomePageData(siteId);
			...
			logError(LogMessageFormatter.formatMessage(request, "HomePageTemplateDroplet|service()|BBBBusinessException","catalog_1042"),be);
			...
			logError(LogMessageFormatter.formatMessage(request, "HomePageTemplateDroplet|service()|BBBSystemException","catalog_1043"),bs);
