...
public class LinkProfileResponseVO implements Serializable{
	...
	public String toString() {
		return "LinkCoRegistrantResponseVO [profileId=" + profileId
				+ ", coRegProfileId()=" + coRegProfileId  + ", isError()=" + isError() + ", getErrorCodes()="
				+ "]";
	}
	/**
	 * @return the errorMap
