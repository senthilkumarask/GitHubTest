...
public class BBBDesEncryptionTools extends BBBGenericService {
	...
	public String decrypt(final String str) {
		try {
			...
			logError(LogMessageFormatter.formatMessage(null, "BadPaddingException -during Decryption", BBBCoreErrorConstants.ACCOUNT_ERROR_1077 ) +  e.getMessage(),e);
		} catch (IllegalBlockSizeException e) {
			logError(LogMessageFormatter.formatMessage(null, "IllegalBlockSizeException -during Decryption", BBBCoreErrorConstants.ACCOUNT_ERROR_1078 ) +  e.getMessage(),e);
		} catch (UnsupportedEncodingException e) {
			logError(LogMessageFormatter.formatMessage(null, "UnsupportedEncodingException -during Decryption", BBBCoreErrorConstants.ACCOUNT_ERROR_1085 ) +  e.getMessage(),e);
		}
		return null;
	}
}
