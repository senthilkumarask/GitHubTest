...
echo ./../../bin/startSQLRepository -m BBBStore.core -m BBBStore.servertype.bbb_stg -s bbb_impexp_stg_bfx -import $1 -repository $2

./../../bin/startSQLRepository -m BBBStore.core -m BBBStore.servertype.bbb_stg -s bbb_impexp_stg_bfx -import $1 -repository $2
exit 0
else
	echo "Wrong input File. Please provide the correct xml file with absolute path."
	exit 0
