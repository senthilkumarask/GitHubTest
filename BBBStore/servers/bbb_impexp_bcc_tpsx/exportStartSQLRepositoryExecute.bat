...
echo ..\..\bin\startSQLRepository -m DCS.Versioned -m BBBStore.EStore.versioned.catalog -s bbb_impexp_bcc_tpsx -export all %1 -repository %2

..\..\bin\startSQLRepository -m DCS.Versioned -m BBBStore.EStore.versioned.catalog -s bbb_impexp_bcc_tpsx -export all %1 -repository %2
	goto :afterBlank
)else (
