...
echo ..\..\bin\startSQLRepository -m BBBStore.core -m BBBStore.servertype.bbb_stg -s bbb_impexp_stg_dps  -export all %1  -repository %2

..\..\bin\startSQLRepository -m BBBStore.core -m BBBStore.servertype.bbb_stg -s bbb_impexp_stg_dps  -export all %1  -repository %2
	goto :afterBlank
)else (
