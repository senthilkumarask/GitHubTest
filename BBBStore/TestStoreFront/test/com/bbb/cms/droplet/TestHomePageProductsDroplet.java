 ...
 *
 */
public class TestHomePageProductsDroplet extends BaseTestCase {
	public void testHomePageProductsDroplet() throws Exception {
    	
		HomePageProductsDroplet objHomePageProductsDroplet = (HomePageProductsDroplet) getObject("homePageProductsDroplet");
    	String siteId= (String) getObject("siteId");
    	getRequest().setParameter("siteId", siteId);
		
    	objHomePageProductsDroplet.service(getRequest(), getResponse());
    	...
    	assertNotNull(homePageTemplateVO.getFeaturedProduct());
    	assertNotNull(homePageTemplateVO.getSecondaryProducts());
