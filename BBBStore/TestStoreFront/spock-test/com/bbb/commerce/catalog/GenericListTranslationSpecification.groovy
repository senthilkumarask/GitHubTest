...
class GenericListTranslationSpecification extends BBBExtendedSpec {

	GenericListTranslation testObj
	...
	def "derivePropertyValue. Determine the derived property value."(){
		...
		1*pItem.getPropertyValue("prop") >> [r1,r2]
	...
	def "derivePropertyValue. when itemDesc is empty."(){
		...
		1*pItem.getPropertyValue("prop") >> [r1]
