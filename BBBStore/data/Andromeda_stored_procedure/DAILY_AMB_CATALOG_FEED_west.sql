...
BEGIN
  SYS.dbms_scheduler.create_job(
      job_name => 'BBB_CORE.DAILY_AMB_CATALOG_FEED',
      job_type => 'PLSQL_BLOCK',
      job_action => 'BEGIN BBB_CORE.SEND_DELTA_CATALOG_TO_AMB(''4177'', ''4176'', ''WEST''); END;',
      start_date => sysdate,
  ...
  SYS.DBMS_SCHEDULER.enable ('BBB_CORE.DAILY_AMB_CATALOG_FEED');
END;
/
SHOW ERROR;
COMMIT;