...
CREATE OR REPLACE PROCEDURE BBB_CORE_PRV.SEND_DELTA_CATALOG_TO_AMB (bbuMerchId IN VARCHAR2, bbbyMerchId IN VARCHAR2, dataCenter IN VARCHAR2)
IS
...
FROM 
  ...
  bbb_ambassador_usr_prv.BBB_SCH_PROCESS sch
WHERE
