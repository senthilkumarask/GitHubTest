...
UPDATE BBB_SWITCH_B.BBB_CONFIG_KEY_VALUE SET CONFIG_VALUE='T.P.ECFE.ATG.ProPer' WHERE CONFIG_KEY_ID ='BBBJMSObject_EDWProfileData';
UPDATE BBB_SWITCH_B.BBB_CONFIG_KEY_VALUE SET CONFIG_VALUE='ecfe_atgpub_prd' WHERE CONFIG_KEY_ID ='PUBbbCK280004userName';
UPDATE BBB_SWITCH_B.BBB_CONFIG_KEY_VALUE SET CONFIG_VALUE='ecfeatgpubprd' WHERE CONFIG_KEY_ID ='PUBbbCK280004password';
UPDATE BBB_SWITCH_B.BBB_CONFIG_KEY_VALUE SET CONFIG_VALUE='tcp://EANP-ECFE1-P:41103, tcp://EANP-ECFE1-S:41103' WHERE CONFIG_KEY_ID ='DC3PUB600002';
UPDATE BBB_SWITCH_B.BBB_CONFIG_KEY_VALUE SET CONFIG_VALUE='tcp://ESDP-ECFE1-P:41103, tcp://ESDP-ECFE1-S:41103' WHERE CONFIG_KEY_ID ='PUB600003';
UPDATE BBB_SWITCH_B.BBB_CONFIG_KEY_VALUE SET CONFIG_VALUE='tcp://EUPP-ECFE1-P:41103, tcp://EUPP-ECFE1-S:41103' WHERE CONFIG_KEY_ID ='PUB600002';
