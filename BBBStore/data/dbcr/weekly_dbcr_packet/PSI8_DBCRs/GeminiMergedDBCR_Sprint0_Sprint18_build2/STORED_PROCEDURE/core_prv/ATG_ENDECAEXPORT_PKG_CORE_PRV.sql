...
--------------------------------------------------------
  ...
  CREATE OR REPLACE PACKAGE BBB_CORE_PRV.ATG_ENDECAEXPORT_PKG IS
...
-- files for product and sku attributes
    ...
    PROCEDURE export_store_only(p_filename varchar2, p_lastModifiedDate varchar2, p_feedType varchar2);  -- New RSP 8/27/2014  
