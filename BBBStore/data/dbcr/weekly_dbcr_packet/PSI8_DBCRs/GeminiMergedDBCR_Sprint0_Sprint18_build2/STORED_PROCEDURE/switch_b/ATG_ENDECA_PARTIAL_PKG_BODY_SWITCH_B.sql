...
PROCEDURE Export_Controller (p_lastModifiedDate varchar2, p_feedType varchar2)
  ...
  BEGIN
		...
		----- Release 2.2.1 Harmon Tab Sites File END
         ATG_EndecaExport_Pkg.export_store_only('MIESkuProduct.txt', p_lastModifiedDate, p_feedtype);-- New RSP 6/30/2015 
...
BEGIN
    ...
    IF p_feedType = 'FULL' THEN
        ...
        THEN
			...
			----- Release 2.2.1 Harmon Tab Sites File END
             ATG_EndecaExport_Pkg.export_store_only('MIESkuProduct.txt', sysdate, p_feedtype);-- New RSP 6/30/2015  
