...
2. Directly Compile the Stored Procedures in the below Order
	...
	/STORED_PROCEDURE/core_prv/ATG_ENDECAEXPORT_PKG_CORE_PRV.sql			For core_prv Schema; part of build 18.1
	/STORED_PROCEDURE/core_prv/ATG_ENDECAEXPORT_PKG_BODY_CORE_PRV.sql		For core_prv Schema; part of build 18.1
	/STORED_PROCEDURE/core_prv/ATG_ENDECA_PARTIAL_PKG_BODY_CORE_PRV.sql		For core_prv Schema; part of build 18.1
