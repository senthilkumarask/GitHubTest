...
public class SiteDateTranslation extends DerivationMethodImpl {
	...
	protected static final String GUIDED_BBB_ENABLE="gsBBBEnableDate";
	protected static final String GUIDED_BAB_ENABLE="gsBABEnableDate";
	protected static final String GUIDED_CA_ENABLE="gsCAEnableDate";
		...
		try{
			...
			if(siteId.contains(getGSSitePrefix()))
			{
					if (siteId.equals(GUIDED_BBB_SITE_ID)) {
						return getProperyValue(pItem, GUIDED_BBB_ENABLE);
					}
					if (siteId.equals(GUIDED_BAB_SITE_ID)) {
						return getProperyValue(pItem, GUIDED_BAB_ENABLE);
					}
					if (siteId.equals(GUIDED_CA_SITE_ID)) {
						return getProperyValue(pItem, GUIDED_CA_ENABLE);
					}
