...
public class PicklistItem implements Serializable {
    ...
    public PicklistItem(PicklistEntryType t) {
        ...
        */
        m_IsFullAddress = t.getFullAddress();
        m_CanStep = t.getCanStep();
        m_IsAliasMatch = t.getAliasMatch();
        m_IsPostcodeRecoded = t.getPostcodeRecoded();
        m_IsCrossBorderMatch = t.getCrossBorderMatch();
        m_IsDummyPOBox = t.getDummyPOBox();
        m_IsName = t.getName();
        m_IsInformation = t.getInformation();
        m_IsWarnInformation = t.getWarnInformation();
        m_IsIncompleteAddress = t.getIncompleteAddr();
        m_IsUnresolvableRange = t.getUnresolvableRange();
        m_IsPhantomPrimaryPoint = t.getPhantomPrimaryPoint();
        m_IsMultiples = t.getMultiples();
    }
