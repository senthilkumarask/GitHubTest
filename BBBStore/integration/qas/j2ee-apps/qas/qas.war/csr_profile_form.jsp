...
<body>
	...
	<div class="mainContainer">
		...
		<dsp:getvalueof bean="ProfileInfoBean.userSiteAssociations" var="userSiteAssociations" />
			...
			<div>
				<table border="noborder" style="width: 700px;">
					...
					<tr>
							...
							<td>
								<c:forEach items="${userSiteAssociations}" varStatus="loopCounter" var="entry" >
									${entry.key }
									<br>
								</c:forEach>
							</td>
