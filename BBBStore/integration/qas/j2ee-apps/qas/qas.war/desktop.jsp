...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    AppSupport <i class="ion-speedometer" style="margin: 0 8px;"></i> Dashboard
    </h1>
     </nav>
  </header>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="">
          <a href="dashboardNavigation.jsp">
        ...
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Order Data Comparision</h3>
              <dsp:droplet name="/com/bbb/integration/dashboard/DashboardDataDroplet">
					<dsp:param name="operationRequired" value="specificOrderComparision"/>
					<dsp:param name="channel" value="desktop"/>
			       			...
			       			<dsp:droplet name="/atg/dynamo/droplet/ForEach">
								...
								<dsp:oparam name="output">
									...
									<dsp:getvalueof var="orderCount" param="element"/>								
					                 <c:if test="${not empty timeDuration}">       
					                    <tr>
						                      <td>${timeDuration}</td>
						                      <td>${orderCount}</td>
					                    </tr>
              ...
              <div class="row">
                ...
                <div class="col-md-3 col-xs-11">
                  <p class="text-center" style="padding-bottom:10px">
                    <strong>Today's Order Summary</strong>
                  </p>

                  <div class="progress-group">
                    <span class="progress-text">Desktop Orders</span>
                    <span class="progress-number"><b>${submittedOrderCountStore}</span>
                  ...
                  <!-- /.progress-group -->
                  <div class="progress-group">
                    <span class="progress-text">Mobile Orders</span>
                    <span class="progress-number"><b>${submittedOrderCountMobile}</span>
                  ...
                  <!-- /.progress-group -->
                  <div class="progress-group">
                    <span class="progress-text">TBS Orders</span>
                    <span class="progress-number"><b>${submittedOrderCountTBS}</span>
