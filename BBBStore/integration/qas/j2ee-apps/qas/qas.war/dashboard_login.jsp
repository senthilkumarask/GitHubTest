...
<body>
	<div class="centerAlign">
		<h2>Production Support Monitoring Dashboard</h2>
	</div>
				...
				<td><dsp:form id="profileInfo" iclass="clearfix"
						...
						<table class="leftContainer">
							...
							<tr>
								...
								<td><dsp:input type="text" bean="DashboardFormHandler.adminName"
										maxlength="40" name="adminName" id="adminName" /></td>
							</tr>
							<tr>
								<td><strong>Password</strong><span class="required">*</span>
								</td>
								<td><dsp:input type="password"
										bean="DashboardFormHandler.adminPassword" maxlength="40" name="adminPassword"
										id="adminPassword" /></td>
							</tr>
							<tr>
								<td></td>
							...
							<tr>
								<td colspan="2"><dsp:input
										bean="DashboardFormHandler.ValidateUser" id="validatUser"
										type="Submit" value="View Dashboard" /></td>
							</tr>
						</table>
					</dsp:form></td>
