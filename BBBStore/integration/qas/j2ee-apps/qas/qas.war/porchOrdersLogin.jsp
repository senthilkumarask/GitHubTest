...
<dsp:page>
	...
	<html>
	<head>
	<title>Porch Process Orders</title>
	...
	<body>
		...
		<dsp:form id="cacheInfo" iclass="clearfix"
			action="processPorchOrder.jsp" method="post">
			<table border="noborder" style="width: 600px;">
				<tr>
					<td><strong>Admin Name</strong><span class="required">*</span>
					</td>
					<td><dsp:input type="text" bean="PorchOrderProcessFormHandler.adminName" maxlength="40" name="adminName" id="adminName" /></td>
				</tr>
				<tr>
					<td><strong>Admin Password</strong><span class="required">*</span>
					</td>
					<td><dsp:input type="password" bean="PorchOrderProcessFormHandler.adminPassword" maxlength="40" name="adminPassword" id="adminPassword" /></td>
				</tr>
				<tr>
					<td colspan="2"><dsp:input bean="PorchOrderProcessFormHandler.validateUser" id="cacheInfoBtn" type="Submit" value="Submit" />
					</td>
				</tr>
			</table>
		</dsp:form>
