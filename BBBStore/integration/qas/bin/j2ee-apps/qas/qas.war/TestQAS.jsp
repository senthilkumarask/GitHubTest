...
<table border="noborder">
	...
	<tr>
	  ...
	  <td><dsp:select bean="TestQASFormHandler.address.state" iclass="custom_select" name="atg_store_stateSelect" id="atg_store_stateSelect">
	  		...
	  		<dsp:option value="PW">Palau</dsp:option>
	  		<dsp:option value="GU">Guam</dsp:option>
	  		<dsp:option value="FM">Federated States of Micronesia</dsp:option>
	  		<dsp:option value="MP">Northern Mariana Islands</dsp:option>
	  		<dsp:option value="MH">Republic of the Marshall Islands</dsp:option>
	  		<dsp:option value="VI">United States Virgin Islands</dsp:option>
	  		<dsp:option value="AS">American Samoa</dsp:option>
	  		<dsp:option value="PR">Puerto Rico</dsp:option>
	  	  </dsp:select>
	  </td>
	</tr>
	<tr>
