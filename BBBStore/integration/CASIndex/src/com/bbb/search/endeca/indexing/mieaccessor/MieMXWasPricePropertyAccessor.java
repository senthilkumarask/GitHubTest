...
public class MieMXWasPricePropertyAccessor extends PropertyAccessorImpl implements IndexConstants {
	...
	protected Object getTextOrMetaPropertyValue(Context pContext,
		...
		if(null!=pItem){
			listPrice = getAccessorHelper().getMieCAListPrice(pItem, AccessorConstants.MEXICAN_LIST_PRICE_LIST_ID);
		}
		return listPrice;
	}
