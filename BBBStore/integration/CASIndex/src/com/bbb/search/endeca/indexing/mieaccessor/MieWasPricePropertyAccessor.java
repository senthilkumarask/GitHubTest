...
public class MieWasPricePropertyAccessor extends PropertyAccessorImpl implements IndexConstants {
	...
	protected Object getTextOrMetaPropertyValue(Context pContext,RepositoryItem pItem, String pPropertyName, PropertyTypeEnum pType) {
		...
		if(null!=pItem){
			listPrice = getAccessorHelper().getMieCAListPrice(pItem, AccessorConstants.US_LIST_PRICE_LIST_ID);
		}
		return listPrice;
	}
