...
public class MieMXIsPricePropertyAccessor extends PropertyAccessorImpl implements IndexConstants {
	...
	protected Object getTextOrMetaPropertyValue(Context pContext,
		...
		if(null!=pItem){
			listPrice = getAccessorHelper().getMieCAListPrice(pItem, AccessorConstants.MEXICAN_SALE_PRICE_LIST_ID);
		}
		return listPrice;
	}
