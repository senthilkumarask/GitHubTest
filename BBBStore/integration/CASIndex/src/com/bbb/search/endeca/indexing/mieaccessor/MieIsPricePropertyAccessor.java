...
public class MieIsPricePropertyAccessor extends PropertyAccessorImpl implements IndexConstants {
	...
	protected Object getTextOrMetaPropertyValue(Context pContext,RepositoryItem pItem, String pPropertyName, PropertyTypeEnum pType) {
		...
		if(null!=pItem){
			listPrice = getAccessorHelper().getMieListPrice(pItem, AccessorConstants.US_SALE_PRICE_LIST_ID);
		}
		return listPrice;
	}
