...
import com.bedbathandbeyond.www.GetRegistryInfo2ResponseDocument;
import com.bedbathandbeyond.www.GetRegistryInfo2ResponseDocument.GetRegistryInfo2Response;
 ...
 * 
 */
public class GetRegistryInfo2ServiceUnMarshaller extends ResponseUnMarshaller {
	...
	public ServiceResponseIF processResponse(final XmlObject responseDocument)
		...
		if (responseDocument != null) {
			...
			try {
				...
				final GetRegistryInfo2Response regInfoRes = ((GetRegistryInfo2ResponseDocument) responseDocument)
						.getGetRegistryInfo2Response();

				if (regInfoRes != null) {
					if (!regInfoRes.getGetRegistryInfo2Result().
						...
						registryResVO.getServiceErrorVO().setErrorId(
								regInfoRes.getGetRegistryInfo2Result().getStatus().getID());
						registryResVO.getServiceErrorVO()
								.setErrorMessage(regInfoRes
												.getGetRegistryInfo2Result().getStatus().getErrorMessage());
